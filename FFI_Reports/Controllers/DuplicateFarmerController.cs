...
{
    public class DuplicateFarmerController : Controller
    {
...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        string dbstring = "";
        // GET: ICDReports
        log4net.ILog logger = log4net.LogManager.GetLogger(typeof(DuplicateFarmerController));

        public DuplicateFarmerController(IWebHostEnvironment webHostEnvironment, IConfiguration configuration, IHostingEnvironment hostingEnvironment)
        {
        ...
        public IActionResult FarmerExceptionalReport()
        {
            return View();
        }

        [HttpPost]
        public string getduplicatefarmerreport()
        {
            ...
            con.Open();
            MySqlCommand cmd = new MySqlCommand("pr_farmer_exceptional_report", con);
