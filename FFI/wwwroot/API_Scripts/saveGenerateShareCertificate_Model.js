...
function saveGenerateShareCertificateRequest(data)
{
    /**
     * @member {saveGenerateShareCertificateRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new saveGenerateShareCertificateRequestcontext(data['context']);
    }
}

function saveGenerateShareCertificateRequestcontext(data)
{
    /**
    ...
    /**
     * @member {saveGenerateShareCertificateRequestHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {saveGenerateShareCertificateRequestDetail} Detail
     */
    this['Detail'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new saveGenerateShareCertificateRequestHeader(data['Header']);
        ...
        if(data.hasOwnProperty('Detail') && data['Detail'] != null)
        {
            ...
            {
                Detail.push(new saveGenerateShareCertificateRequestDetail(data['Detail'][Detailindex]));
            }
            this['Detail'] = Detail;
        }
    }
...
function saveGenerateShareCertificateRequestHeader(data)
{
    /**
...
function saveGenerateShareCertificateRequestDetail(data)
{
    /**
...
function saveGenerateShareCertificateResponse(data, format)
{
    /**
     * @member {saveGenerateShareCertificateResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {saveGenerateShareCertificateResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new saveGenerateShareCertificateResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new saveGenerateShareCertificateResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new saveGenerateShareCertificateResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new saveGenerateShareCertificateResponseApplicationException(data['ApplicationException']);
        }
    }
}

function saveGenerateShareCertificateResponseApplicationException(data)
{
    /**
...
function saveGenerateShareCertificateResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {saveGenerateShareCertificateResponseHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new saveGenerateShareCertificateResponseHeader(data.getElementsByTagName("Header")[0]);
        }
        else {
            this['orgnId'] = data['orgnId'];
            ...
            this['Header'] = new saveGenerateShareCertificateResponseHeader(data['Header']);
        }
    }
}

function saveGenerateShareCertificateResponseHeader(data)
{
    /**
     * @member {Int16} register_rowid
     */
