...
function retrieveESPRegRequest(data)
{
    /**
     * @member {retrieveESPRegRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveESPRegRequestcontext(data['context']);
    }
}

function retrieveESPRegRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveESPRegRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveESPRegRequestHeader(data['Header']);
    }
}

function retrieveESPRegRequestHeader(data)
{
    /**
...
function retrieveESPRegResponse(data, format)
{
    /**
     * @member {retrieveESPRegResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveESPRegResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveESPRegResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveESPRegResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveESPRegResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveESPRegResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveESPRegResponseApplicationException(data)
{
    /**
...
function retrieveESPRegResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveESPRegResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {retrieveESPRegResponseAddress} Address
     */
    this['Address'] = null;
    
    /**
     * @member {retrieveESPRegResponseBearers} Bearers
     */
    this['Bearers'] = null;
    
    /**
     * @member {retrieveESPRegResponseBank} Bank
     */
    this['Bank'] = null;
    
    /**
     * @member {retrieveESPRegResponseUser} User
     */
    this['User'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveESPRegResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Address = [];
            for(Addresschildi = 0; Addresschildi < data.getElementsByTagName("Address").length; Addresschildi++)
            {
                Address.push(new retrieveESPRegResponseAddress(data.getElementsByTagName("Address")[Addresschildi]));
            }
            ...
            {
                Bearers.push(new retrieveESPRegResponseBearers(data.getElementsByTagName("Bearers")[Bearerschildi]));
            }
            ...
            {
                Bank.push(new retrieveESPRegResponseBank(data.getElementsByTagName("Bank")[Bankchildi]));
            }
            ...
            {
                User.push(new retrieveESPRegResponseUser(data.getElementsByTagName("User")[Userchildi]));
            }
            ...
            this['Header'] = new retrieveESPRegResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Address') && data['Address'] != null)
            {
                ...
                {
                    Address.push(new retrieveESPRegResponseAddress(data['Address'][Addressindex]));
                }
                this['Address'] = Address;
            }
            ...
            if(data.hasOwnProperty('Bearers') && data['Bearers'] != null)
            {
                ...
                {
                    Bearers.push(new retrieveESPRegResponseBearers(data['Bearers'][Bearersindex]));
                }
                this['Bearers'] = Bearers;
            }
            ...
            if(data.hasOwnProperty('Bank') && data['Bank'] != null)
            {
                ...
                {
                    Bank.push(new retrieveESPRegResponseBank(data['Bank'][Bankindex]));
                }
                this['Bank'] = Bank;
            }
            ...
            if(data.hasOwnProperty('User') && data['User'] != null)
            {
                ...
                {
                    User.push(new retrieveESPRegResponseUser(data['User'][Userindex]));
                }
                this['User'] = User;
            }
        }
...
function retrieveESPRegResponseHeader(data)
{
    /**
     * @member {Int32} orgn_rowid
     */
...
function retrieveESPRegResponseAddress(data)
{
    /**
...
function retrieveESPRegResponseBearers(data)
{
    /**
...
function retrieveESPRegResponseBank(data)
{
    /**
...
function retrieveESPRegResponseUser(data)
{
    /**
