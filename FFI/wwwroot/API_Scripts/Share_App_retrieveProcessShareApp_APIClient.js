var ShareApplication_Share_App_retrieveProcessShareApp = {
    /*
    ...
    invoke: function (retrieveProcessShareApp_Request, callbackHandler)
    {
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/ShareApplication/process_share?org=" + param_orgnid + "&locn=" + param_locnid + "&user=" + param_userid + "&lang=" + param_localeid + "&shareapp_rowid=" + param_shareapp_rowid + "&fpoorgn_code=" + param_fpoorgn_code + "";
        
        WebAPIProxy.invokeAPI("GET", targetURL, null, contentType, responseFormat, null, ShareApplication_Share_App_retrieveProcessShareApp.retrieveProcessShareApp_ResponseHandler);
        return true;
    },
    ...
    retrieveProcessShareApp_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            var retrieveProcessShareApp_ResponseObject = new retrieveProcessShareAppResponse(responseData, "JSON");
            ShareApplication_Share_App_retrieveProcessShareApp.callbackfunction(retrieveProcessShareApp_ResponseObject, textStatus);
        }
        else {
            ShareApplication_Share_App_retrieveProcessShareApp.callbackfunction(responseData, textStatus);
        }
    },
    ...
    invokeAPI: function (contextrequestObject, HeaderrequestObject, callbackHandler)
    {
        ...
        var param_shareapp_rowid = (HeaderrequestObject && HeaderrequestObject.hasOwnProperty('shareapp_rowid')) ? HeaderrequestObject["shareapp_rowid"] : null; //Integer(32)
