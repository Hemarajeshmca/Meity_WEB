var ReceiptUpdation_receipt_update_retrieveReceiptUpdationList = {
    /*
    ...
    invoke: function (retrieveReceiptUpdationList_Request, callbackHandler)
    {
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/ReceiptUpdation/allreceipt?org=" + param_orgnid + "&locn=" + param_locnid + "&user=" + param_userid + "&lang=" + param_localeid + "&filterby_option=" + param_filterby_option + "&filterby_code=" + param_filterby_code + "&filterby_fromvalue=" + param_filterby_fromvalue + "&filterby_tovalue=" + param_filterby_tovalue + "";
        
        WebAPIProxy.invokeAPI("GET", targetURL, null, contentType, responseFormat, null, ReceiptUpdation_receipt_update_retrieveReceiptUpdationList.retrieveReceiptUpdationList_ResponseHandler);
        return true;
    },
    ...
    retrieveReceiptUpdationList_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            ...
            ReceiptUpdation_receipt_update_retrieveReceiptUpdationList.callbackfunction(retrieveReceiptUpdationList_ResponseObject, textStatus);
        }
        else {
            ReceiptUpdation_receipt_update_retrieveReceiptUpdationList.callbackfunction(responseData, textStatus);
        }
    },
