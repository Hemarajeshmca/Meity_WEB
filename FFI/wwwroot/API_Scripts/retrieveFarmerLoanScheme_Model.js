...
function retrieveFarmerLoanSchemeRequest(data)
{
    /**
     * @member {retrieveFarmerLoanSchemeRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveFarmerLoanSchemeRequestcontext(data['context']);
    }
}

function retrieveFarmerLoanSchemeRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveFarmerLoanSchemeRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveFarmerLoanSchemeRequestHeader(data['Header']);
    }
}

function retrieveFarmerLoanSchemeRequestHeader(data)
{
    /**
...
function retrieveFarmerLoanSchemeResponse(data, format)
{
    /**
     * @member {retrieveFarmerLoanSchemeResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveFarmerLoanSchemeResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveFarmerLoanSchemeResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveFarmerLoanSchemeResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveFarmerLoanSchemeResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveFarmerLoanSchemeResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveFarmerLoanSchemeResponseApplicationException(data)
{
    /**
...
function retrieveFarmerLoanSchemeResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveFarmerLoanSchemeResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {retrieveFarmerLoanSchemeResponseSubvention} Subvention
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveFarmerLoanSchemeResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Subvention = [];
            for(Subventionchildi = 0; Subventionchildi < data.getElementsByTagName("Subvention").length; Subventionchildi++)
            {
                Subvention.push(new retrieveFarmerLoanSchemeResponseSubvention(data.getElementsByTagName("Subvention")[Subventionchildi]));
            }
            ...
            this['Header'] = new retrieveFarmerLoanSchemeResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Subvention') && data['Subvention'] != null)
            {
                ...
                {
                    Subvention.push(new retrieveFarmerLoanSchemeResponseSubvention(data['Subvention'][Subventionindex]));
                }
                this['Subvention'] = Subvention;
            }
        }
...
function retrieveFarmerLoanSchemeResponseHeader(data)
{
    /**
...
function retrieveFarmerLoanSchemeResponseSubvention(data)
{
    /**
