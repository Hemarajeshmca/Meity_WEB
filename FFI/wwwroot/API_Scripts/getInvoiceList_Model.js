...
function getInvoiceListRequest(data)
{
    /**
     * @member {getInvoiceListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new getInvoiceListRequestcontext(data['context']);
    }
}

function getInvoiceListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {getInvoiceListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new getInvoiceListRequestFilter(data['Filter']);
    }
}

function getInvoiceListRequestFilter(data)
{
    /**
...
function getInvoiceListResponse(data, format)
{
    /**
     * @member {getInvoiceListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {getInvoiceListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new getInvoiceListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new getInvoiceListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new getInvoiceListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new getInvoiceListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function getInvoiceListResponseApplicationException(data)
{
    /**
...
function getInvoiceListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {getInvoiceListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new getInvoiceListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new getInvoiceListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function getInvoiceListResponseList(data)
{
    /**
