var LRS_LRS_LOAN_retrieveFPOLoanList = {
    /*
    ...
    invoke: function (retrieveFPOLoanList_Request, callbackHandler)
    {
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/LRS/allfpo_loan?org=" + param_orgnid + "&locn=" + param_locnid + "&user=" + param_userid + "&lang=" + param_localeid + "&filterby_option=" + param_filterby_option + "&filterby_code=" + param_filterby_code + "&filterby_fromvalue=" + param_filterby_fromvalue + "&filterby_tovalue=" + param_filterby_tovalue + "";
        
        WebAPIProxy.invokeAPI("GET", targetURL, null, contentType, responseFormat, null, LRS_LRS_LOAN_retrieveFPOLoanList.retrieveFPOLoanList_ResponseHandler);
        return true;
    },
    ...
    retrieveFPOLoanList_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            var retrieveFPOLoanList_ResponseObject = new retrieveFPOLoanListResponse(JSON.parse(responseData), "JSON");
            LRS_LRS_LOAN_retrieveFPOLoanList.callbackfunction(retrieveFPOLoanList_ResponseObject, textStatus);
        }
        else {
            LRS_LRS_LOAN_retrieveFPOLoanList.callbackfunction(responseData, textStatus);
        }
    },
