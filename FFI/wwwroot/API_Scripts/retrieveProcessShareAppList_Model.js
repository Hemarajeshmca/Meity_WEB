...
function retrieveProcessShareAppListRequest(data)
{
    /**
     * @member {retrieveProcessShareAppListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveProcessShareAppListRequestcontext(data['context']);
    }
}

function retrieveProcessShareAppListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveProcessShareAppListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveProcessShareAppListRequestFilter(data['Filter']);
    }
}

function retrieveProcessShareAppListRequestFilter(data)
{
    /**
...
function retrieveProcessShareAppListResponse(data, format)
{
    /**
     * @member {retrieveProcessShareAppListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveProcessShareAppListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveProcessShareAppListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveProcessShareAppListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveProcessShareAppListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveProcessShareAppListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveProcessShareAppListResponseApplicationException(data)
{
    /**
...
function retrieveProcessShareAppListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveProcessShareAppListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrieveProcessShareAppListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveProcessShareAppListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveProcessShareAppListResponseList(data)
{
    /**
