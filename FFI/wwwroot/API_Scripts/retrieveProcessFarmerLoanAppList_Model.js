...
function retrieveProcessFarmerLoanAppListRequest(data)
{
    /**
     * @member {retrieveProcessFarmerLoanAppListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveProcessFarmerLoanAppListRequestcontext(data['context']);
    }
}

function retrieveProcessFarmerLoanAppListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveProcessFarmerLoanAppListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveProcessFarmerLoanAppListRequestFilter(data['Filter']);
    }
}

function retrieveProcessFarmerLoanAppListRequestFilter(data)
{
    /**
...
function retrieveProcessFarmerLoanAppListResponse(data, format)
{
    /**
     * @member {retrieveProcessFarmerLoanAppListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveProcessFarmerLoanAppListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveProcessFarmerLoanAppListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveProcessFarmerLoanAppListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveProcessFarmerLoanAppListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveProcessFarmerLoanAppListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveProcessFarmerLoanAppListResponseApplicationException(data)
{
    /**
...
function retrieveProcessFarmerLoanAppListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveProcessFarmerLoanAppListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrieveProcessFarmerLoanAppListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveProcessFarmerLoanAppListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveProcessFarmerLoanAppListResponseList(data)
{
    /**
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            if(data.getElementsByTagName("app_remark")[0].attributes.length == 0) //Check NULL value
                this['app_remark'] = (data.getElementsByTagName("app_remark")[0].lastChild != null) ? data.getElementsByTagName("app_remark")[0].lastChild.nodeValue : "";
            
            this['app_note'] = (data.getElementsByTagName("app_note")[0].lastChild != null) ? data.getElementsByTagName("app_note")[0].lastChild.nodeValue : "";
