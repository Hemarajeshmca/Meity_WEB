var InvoiceGeneration_Invoice_Generation_getInvoiceGenerationList = {
    /*
    ...
    invoke: function (getInvoiceGenerationList_Request, callbackHandler)
    {
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/InvoiceGeneration/allinvoicegenerate?org=" + param_orgnid + "&locn=" + param_locnid + "&user=" + param_userid + "&lang=" + param_localeid + "&filterby_option=" + param_filterby_option + "&filterby_code=" + param_filterby_code + "&filterby_fromvalue=" + param_filterby_fromvalue + "&filterby_tovalue=" + param_filterby_tovalue + "";
        
        WebAPIProxy.invokeAPI("GET", targetURL, null, contentType, responseFormat, null, InvoiceGeneration_Invoice_Generation_getInvoiceGenerationList.getInvoiceGenerationList_ResponseHandler);
        return true;
    },
    ...
    getInvoiceGenerationList_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            ...
            InvoiceGeneration_Invoice_Generation_getInvoiceGenerationList.callbackfunction(getInvoiceGenerationList_ResponseObject, textStatus);
        }
        else {
            InvoiceGeneration_Invoice_Generation_getInvoiceGenerationList.callbackfunction(responseData, textStatus);
        }
    },
