...
function retrieveFarmerProfileRequest(data)
{
    /**
     * @member {retrieveFarmerProfileRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveFarmerProfileRequestcontext(data['context']);
    }
}

function retrieveFarmerProfileRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveFarmerProfileRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveFarmerProfileRequestHeader(data['Header']);
    }
}

function retrieveFarmerProfileRequestHeader(data)
{
    /**
...
function retrieveFarmerProfileResponse(data, format)
{
    /**
     * @member {retrieveFarmerProfileResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveFarmerProfileResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveFarmerProfileResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveFarmerProfileResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveFarmerProfileResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveFarmerProfileResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveFarmerProfileResponseApplicationException(data)
{
    /**
...
function retrieveFarmerProfileResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveFarmerProfileResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {retrieveFarmerProfileResponseDynamic} Dynamic
     */
    this['Dynamic'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveFarmerProfileResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Dynamic = [];
            for(Dynamicchildi = 0; Dynamicchildi < data.getElementsByTagName("Dynamic").length; Dynamicchildi++)
            {
                Dynamic.push(new retrieveFarmerProfileResponseDynamic(data.getElementsByTagName("Dynamic")[Dynamicchildi]));
            }
            if(data.getElementsByTagName("Dynamic").length > 0)
            ...
            this['Header'] = new retrieveFarmerProfileResponseHeader(data['Header']);
            
            
            if(data.hasOwnProperty('Dynamic') && data['Dynamic'] != null)
            {
                Dynamic = [];
                for(Dynamicindex = 0; Dynamicindex < data['Dynamic'].length; Dynamicindex++)
                {
                    Dynamic.push(new retrieveFarmerProfileResponseDynamic(data['Dynamic'][Dynamicindex]));
                }
                this['Dynamic'] = Dynamic;
            }
        }
...
function retrieveFarmerProfileResponseHeader(data)
{
    /**
     * @member {Int32} farmer_rowid
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['detail'] = (data.getElementsByTagName("detail")[0].lastChild != null) ? data.getElementsByTagName("detail")[0].lastChild.nodeValue : "";
        }
        else {
            this['farmer_rowid'] = data['farmer_rowid'];
...
function retrieveFarmerProfileResponseDynamic(data)
{
    /**
     * @member {Int16} sl_no
     */
    ...
    /**
     * @member {String} dynamic_list
     */
    this['dynamic_list'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['dynamic_list'] = (data.getElementsByTagName("dynamic_list")[0].lastChild != null) ? data.getElementsByTagName("dynamic_list")[0].lastChild.nodeValue : "";
        }
        else {
            this['sl_no'] = data['sl_no'];
            
            this['dynamic_list'] = data['dynamic_list'];
        }
    }
}
