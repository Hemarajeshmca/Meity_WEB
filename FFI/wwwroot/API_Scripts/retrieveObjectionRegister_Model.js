...
function retrieveObjectionRegisterRequest(data)
{
    /**
     * @member {retrieveObjectionRegisterRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveObjectionRegisterRequestcontext(data['context']);
    }
}

function retrieveObjectionRegisterRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveObjectionRegisterRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveObjectionRegisterRequestHeader(data['Header']);
    }
}

function retrieveObjectionRegisterRequestHeader(data)
{
    /**
...
function retrieveObjectionRegisterResponse(data, format)
{
    /**
     * @member {retrieveObjectionRegisterResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveObjectionRegisterResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveObjectionRegisterResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveObjectionRegisterResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveObjectionRegisterResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveObjectionRegisterResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveObjectionRegisterResponseApplicationException(data)
{
    /**
...
function retrieveObjectionRegisterResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveObjectionRegisterResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {retrieveObjectionRegisterResponseDetail} Detail
     */
    this['Detail'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveObjectionRegisterResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Detail = [];
            for(Detailchildi = 0; Detailchildi < data.getElementsByTagName("Detail").length; Detailchildi++)
            {
                Detail.push(new retrieveObjectionRegisterResponseDetail(data.getElementsByTagName("Detail")[Detailchildi]));
            }
            ...
            this['Header'] = new retrieveObjectionRegisterResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Detail') && data['Detail'] != null)
            {
                ...
                {
                    Detail.push(new retrieveObjectionRegisterResponseDetail(data['Detail'][Detailindex]));
                }
                this['Detail'] = Detail;
            }
        }
...
function retrieveObjectionRegisterResponseHeader(data)
{
    /**
...
function retrieveObjectionRegisterResponseDetail(data)
{
    /**
