    ...
    if (textStatus == "success") {
        ...
        if (responseJSON.ApplicationException != null) {
            ...
            try {
                ...
                generate_WhsReceipt_Detail(responseJSON.context.Detail);
                return true;
            }
            catch (e) {
                javascript_log4j_root(arguments.callee.name, e);
...
function retrieve_WhsMasterGETITEM(HeaderrequestObject) {
    WarehouseReceipting_Warehouse_Receipting_PAWHS_ItemFetch.invoke(HeaderrequestObject, retrieve_WhsReceiptGETITEM_ResponseHandler);
}

function retrieve_WhsReceiptGETITEM_ResponseHandler(data, textStatus) {
    if (textStatus == "success") {
        //responseJSON = jQuery.parseJSON(data);
        responseJSON = data;
        if (responseJSON.ApplicationException != null) {
            ...
            try {
                generate_WhsReceiptGETITEM_header(responseJSON.context.Header);
                generate_WhsReceiptGETITEM_Detail(responseJSON.context.Detail);
                return true;
            }
            catch (e) {
                javascript_log4j_root(arguments.callee.name, e);
