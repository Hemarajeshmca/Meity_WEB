...
function PAWHS_saveServiceInvoiceRequest(data)
{
    /**
     * @member {PAWHS_saveServiceInvoiceRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new PAWHS_saveServiceInvoiceRequestcontext(data['context']);
    }
}

function PAWHS_saveServiceInvoiceRequestcontext(data)
{
    /**
    ...
    /**
     * @member {PAWHS_saveServiceInvoiceRequestHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {PAWHS_saveServiceInvoiceRequestInvoiceDetails} InvoiceDetails
     */
    this['InvoiceDetails'] = null;
    
    /**
     * @member {PAWHS_saveServiceInvoiceRequestTaxDetails} TaxDetails
     */
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new PAWHS_saveServiceInvoiceRequestHeader(data['Header']);
        ...
        if(data.hasOwnProperty('InvoiceDetails') && data['InvoiceDetails'] != null)
        {
            ...
            {
                InvoiceDetails.push(new PAWHS_saveServiceInvoiceRequestInvoiceDetails(data['InvoiceDetails'][InvoiceDetailsindex]));
            }
        ...
        if(data.hasOwnProperty('TaxDetails') && data['TaxDetails'] != null)
        {
            ...
            {
                TaxDetails.push(new PAWHS_saveServiceInvoiceRequestTaxDetails(data['TaxDetails'][TaxDetailsindex]));
            }
...
function PAWHS_saveServiceInvoiceRequestHeader(data)
{
    /**
...
function PAWHS_saveServiceInvoiceRequestInvoiceDetails(data)
{
    /**
...
function PAWHS_saveServiceInvoiceRequestTaxDetails(data)
{
    /**
...
function PAWHS_saveServiceInvoiceResponse(data, format)
{
    /**
     * @member {PAWHS_saveServiceInvoiceResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {PAWHS_saveServiceInvoiceResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new PAWHS_saveServiceInvoiceResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new PAWHS_saveServiceInvoiceResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new PAWHS_saveServiceInvoiceResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new PAWHS_saveServiceInvoiceResponseApplicationException(data['ApplicationException']);
        }
    }
}

function PAWHS_saveServiceInvoiceResponseApplicationException(data)
{
    /**
...
function PAWHS_saveServiceInvoiceResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {PAWHS_saveServiceInvoiceResponseHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new PAWHS_saveServiceInvoiceResponseHeader(data.getElementsByTagName("Header")[0]);
        }
        else {
            this['orgnId'] = data['orgnId'];
            ...
            this['Header'] = new PAWHS_saveServiceInvoiceResponseHeader(data['Header']);
        }
    }
}

function PAWHS_saveServiceInvoiceResponseHeader(data)
{
    /**
     * @member {Int32} invoice_rowid
     */
