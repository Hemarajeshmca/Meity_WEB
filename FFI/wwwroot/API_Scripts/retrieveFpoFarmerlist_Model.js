...
function retrieveFpoFarmerlistRequest(data)
{
    /**
     * @member {retrieveFpoFarmerlistRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveFpoFarmerlistRequestcontext(data['context']);
    }
}

function retrieveFpoFarmerlistRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveFpoFarmerlistRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveFpoFarmerlistRequestFilter(data['Filter']);
    }
}

function retrieveFpoFarmerlistRequestFilter(data)
{
    /**
...
function retrieveFpoFarmerlistResponse(data, format)
{
    /**
     * @member {retrieveFpoFarmerlistResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveFpoFarmerlistResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveFpoFarmerlistResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveFpoFarmerlistResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveFpoFarmerlistResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveFpoFarmerlistResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveFpoFarmerlistResponseApplicationException(data)
{
    /**
...
function retrieveFpoFarmerlistResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveFpoFarmerlistResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrieveFpoFarmerlistResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveFpoFarmerlistResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveFpoFarmerlistResponseList(data)
{
    /**
