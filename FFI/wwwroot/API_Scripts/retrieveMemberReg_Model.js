...
function retrieveMemberRegRequest(data)
{
    /**
     * @member {retrieveMemberRegRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveMemberRegRequestcontext(data['context']);
    }
}

function retrieveMemberRegRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveMemberRegRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveMemberRegRequestHeader(data['Header']);
    }
}

function retrieveMemberRegRequestHeader(data)
{
    /**
     * @member {String} esp_type_code
     */
    this['esp_type_code'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('esp_type_code'))
            this['esp_type_code'] = data['esp_type_code'];
...
function retrieveMemberRegResponse(data, format)
{
    /**
     * @member {retrieveMemberRegResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveMemberRegResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveMemberRegResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveMemberRegResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveMemberRegResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveMemberRegResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveMemberRegResponseApplicationException(data)
{
    /**
...
function retrieveMemberRegResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveMemberRegResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {retrieveMemberRegResponseAddress} Address
     */
    this['Address'] = null;
    
    /**
     * @member {retrieveMemberRegResponseBank} Bank
     */
    this['Bank'] = null;
    
    /**
     * @member {retrieveMemberRegResponseUser} User
     */
    this['User'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveMemberRegResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Address = [];
            for(Addresschildi = 0; Addresschildi < data.getElementsByTagName("Address").length; Addresschildi++)
            {
                Address.push(new retrieveMemberRegResponseAddress(data.getElementsByTagName("Address")[Addresschildi]));
            }
            ...
            {
                Bank.push(new retrieveMemberRegResponseBank(data.getElementsByTagName("Bank")[Bankchildi]));
            }
            ...
            {
                User.push(new retrieveMemberRegResponseUser(data.getElementsByTagName("User")[Userchildi]));
            }
            ...
            this['Header'] = new retrieveMemberRegResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Address') && data['Address'] != null)
            {
                ...
                {
                    Address.push(new retrieveMemberRegResponseAddress(data['Address'][Addressindex]));
                }
                this['Address'] = Address;
            }
            ...
            if(data.hasOwnProperty('Bank') && data['Bank'] != null)
            {
                ...
                {
                    Bank.push(new retrieveMemberRegResponseBank(data['Bank'][Bankindex]));
                }
                this['Bank'] = Bank;
            }
            ...
            if(data.hasOwnProperty('User') && data['User'] != null)
            {
                ...
                {
                    User.push(new retrieveMemberRegResponseUser(data['User'][Userindex]));
                }
                this['User'] = User;
            }
        }
...
function retrieveMemberRegResponseHeader(data)
{
    /**
     * @member {String} esp_type_code
     */
    ...
    {
        if (responseDataFormat == "XML") {
            this['esp_type_code'] = (data.getElementsByTagName("esp_type_code")[0].lastChild != null) ? data.getElementsByTagName("esp_type_code")[0].lastChild.nodeValue : "";
...
function retrieveMemberRegResponseAddress(data)
{
    /**
...
function retrieveMemberRegResponseBank(data)
{
    /**
...
function retrieveMemberRegResponseUser(data)
{
    /**
