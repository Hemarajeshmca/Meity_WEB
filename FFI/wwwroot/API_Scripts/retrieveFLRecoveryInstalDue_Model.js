...
function retrieveFLRecoveryInstalDueRequest(data)
{
    /**
     * @member {retrieveFLRecoveryInstalDueRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveFLRecoveryInstalDueRequestcontext(data['context']);
    }
}

function retrieveFLRecoveryInstalDueRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveFLRecoveryInstalDueRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveFLRecoveryInstalDueRequestHeader(data['Header']);
    }
}

function retrieveFLRecoveryInstalDueRequestHeader(data)
{
    /**
...
function retrieveFLRecoveryInstalDueResponse(data, format)
{
    /**
     * @member {retrieveFLRecoveryInstalDueResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveFLRecoveryInstalDueResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveFLRecoveryInstalDueResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveFLRecoveryInstalDueResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveFLRecoveryInstalDueResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveFLRecoveryInstalDueResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveFLRecoveryInstalDueResponseApplicationException(data)
{
    /**
...
function retrieveFLRecoveryInstalDueResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveFLRecoveryInstalDueResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {retrieveFLRecoveryInstalDueResponseDetail} Detail
     */
    this['Detail'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveFLRecoveryInstalDueResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Detail = [];
            for(Detailchildi = 0; Detailchildi < data.getElementsByTagName("Detail").length; Detailchildi++)
            {
                Detail.push(new retrieveFLRecoveryInstalDueResponseDetail(data.getElementsByTagName("Detail")[Detailchildi]));
            }
            ...
            this['Header'] = new retrieveFLRecoveryInstalDueResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Detail') && data['Detail'] != null)
            {
                ...
                {
                    Detail.push(new retrieveFLRecoveryInstalDueResponseDetail(data['Detail'][Detailindex]));
                }
                this['Detail'] = Detail;
            }
        }
...
function retrieveFLRecoveryInstalDueResponseHeader(data)
{
    /**
     * @member {String} fig_short_name
     */
...
function retrieveFLRecoveryInstalDueResponseDetail(data)
{
    /**
     * @member {String} fig_short_name
     */
