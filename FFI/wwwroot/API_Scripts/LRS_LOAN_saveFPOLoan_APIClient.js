var LRS_LRS_LOAN_saveFPOLoan = {
    ...
    invoke: function (saveFPOLoan_Request, callbackHandler)
    {
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/LRS/newFPOLoan";
        
        WebAPIProxy.invokeAPI("POST", targetURL, requestdata, contentType, responseFormat, null, LRS_LRS_LOAN_saveFPOLoan.saveFPOLoan_ResponseHandler);
        return true;
    },
    ...
    saveFPOLoan_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            var saveFPOLoan_ResponseObject = new saveFPOLoanResponse(JSON.parse(responseData), "JSON");
            LRS_LRS_LOAN_saveFPOLoan.callbackfunction(saveFPOLoan_ResponseObject, textStatus);
        }
        else {
            LRS_LRS_LOAN_saveFPOLoan.callbackfunction(responseData, textStatus);
        }
    },
