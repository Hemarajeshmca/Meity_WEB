...
function saveObjectionRegisterRequest(data)
{
    /**
     * @member {saveObjectionRegisterRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new saveObjectionRegisterRequestcontext(data['context']);
    }
}

function saveObjectionRegisterRequestcontext(data)
{
    /**
    ...
    /**
     * @member {saveObjectionRegisterRequestHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {saveObjectionRegisterRequestDetail} Detail
     */
    this['Detail'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new saveObjectionRegisterRequestHeader(data['Header']);
        ...
        if(data.hasOwnProperty('Detail') && data['Detail'] != null)
        {
            ...
            {
                Detail.push(new saveObjectionRegisterRequestDetail(data['Detail'][Detailindex]));
            }
            this['Detail'] = Detail;
        }
    }
...
function saveObjectionRegisterRequestHeader(data)
{
    /**
...
function saveObjectionRegisterRequestDetail(data)
{
    /**
...
function saveObjectionRegisterResponse(data, format)
{
    /**
     * @member {saveObjectionRegisterResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {saveObjectionRegisterResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new saveObjectionRegisterResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new saveObjectionRegisterResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new saveObjectionRegisterResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new saveObjectionRegisterResponseApplicationException(data['ApplicationException']);
        }
    }
}

function saveObjectionRegisterResponseApplicationException(data)
{
    /**
...
function saveObjectionRegisterResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {saveObjectionRegisterResponseHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new saveObjectionRegisterResponseHeader(data.getElementsByTagName("Header")[0]);
        }
        else {
            this['orgnId'] = data['orgnId'];
            ...
            this['Header'] = new saveObjectionRegisterResponseHeader(data['Header']);
        }
    }
}

function saveObjectionRegisterResponseHeader(data)
{
    /**
     * @member {Int16} register_rowid
     */
