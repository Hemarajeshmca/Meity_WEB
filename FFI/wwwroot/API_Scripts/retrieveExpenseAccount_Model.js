...
function retrieveExpenseAccountRequest(data)
{
    /**
     * @member {retrieveExpenseAccountRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveExpenseAccountRequestcontext(data['context']);
    }
}

function retrieveExpenseAccountRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveExpenseAccountRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveExpenseAccountRequestHeader(data['Header']);
    }
}

function retrieveExpenseAccountRequestHeader(data)
{
    /**
...
function retrieveExpenseAccountResponse(data, format)
{
    /**
     * @member {retrieveExpenseAccountResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveExpenseAccountResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveExpenseAccountResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveExpenseAccountResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveExpenseAccountResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveExpenseAccountResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveExpenseAccountResponseApplicationException(data)
{
    /**
...
function retrieveExpenseAccountResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveExpenseAccountResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {retrieveExpenseAccountResponseDetail} Detail
     */
    this['Detail'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveExpenseAccountResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Detail = [];
            for(Detailchildi = 0; Detailchildi < data.getElementsByTagName("Detail").length; Detailchildi++)
            {
                Detail.push(new retrieveExpenseAccountResponseDetail(data.getElementsByTagName("Detail")[Detailchildi]));
            }
            ...
            this['Header'] = new retrieveExpenseAccountResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Detail') && data['Detail'] != null)
            {
                ...
                {
                    Detail.push(new retrieveExpenseAccountResponseDetail(data['Detail'][Detailindex]));
                }
                this['Detail'] = Detail;
            }
        }
...
function retrieveExpenseAccountResponseHeader(data)
{
    /**
     * @member {Int32} expense_rowid
     */
...
function retrieveExpenseAccountResponseDetail(data)
{
    /**
    ...
    /**
     * @member {String} expense_head_desc
     */
    this['expense_head_desc'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['incurred_on'] = (data.getElementsByTagName("incurred_on")[0].lastChild != null) ? data.getElementsByTagName("incurred_on")[0].lastChild.nodeValue : "";
            ...
            this['expense_head_desc'] = (data.getElementsByTagName("expense_head_desc")[0].lastChild != null) ? data.getElementsByTagName("expense_head_desc")[0].lastChild.nodeValue : "";
            ...
            this['expense_head_desc'] = data['expense_head_desc'];
