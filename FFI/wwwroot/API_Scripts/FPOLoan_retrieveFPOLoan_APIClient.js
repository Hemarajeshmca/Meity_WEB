var FPO_Loan_FPOLoan_retrieveFPOLoan = {
    /*
    ...
    invoke: function (retrieveFPOLoan_Request, callbackHandler)
    {
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/FPO_Loan/fpo_loan?org=" + param_orgnid + "&locn=" + param_locnid + "&user=" + param_userid + "&lang=" + param_localeid + "&fpoloan_rowid=" + param_fpoloan_rowid + "&fpoorgn_code=" + param_fpoorgn_code + "";
        
        WebAPIProxy.invokeAPI("GET", targetURL, null, contentType, responseFormat, null, FPO_Loan_FPOLoan_retrieveFPOLoan.retrieveFPOLoan_ResponseHandler);
        return true;
    },
    ...
    retrieveFPOLoan_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            var retrieveFPOLoan_ResponseObject = new retrieveFPOLoanResponse(responseData, "JSON");
            FPO_Loan_FPOLoan_retrieveFPOLoan.callbackfunction(retrieveFPOLoan_ResponseObject, textStatus);
        }
        else {
            FPO_Loan_FPOLoan_retrieveFPOLoan.callbackfunction(responseData, textStatus);
        }
    },
    ...
    invokeAPI: function (contextrequestObject, HeaderrequestObject, callbackHandler)
    {
        ...
        var param_fpoloan_rowid = (HeaderrequestObject && HeaderrequestObject.hasOwnProperty('fpoloan_rowid')) ? HeaderrequestObject["fpoloan_rowid"] : null; //Integer(32)
