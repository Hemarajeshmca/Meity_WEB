...
function PAWHS_getMemberRegRequest(data)
{
    /**
     * @member {PAWHS_getMemberRegRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new PAWHS_getMemberRegRequestcontext(data['context']);
    }
}

function PAWHS_getMemberRegRequestcontext(data)
{
    /**
    ...
    /**
     * @member {PAWHS_getMemberRegRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new PAWHS_getMemberRegRequestHeader(data['Header']);
    }
}

function PAWHS_getMemberRegRequestHeader(data)
{
    /**
...
function PAWHS_getMemberRegResponse(data, format)
{
    /**
     * @member {PAWHS_getMemberRegResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {PAWHS_getMemberRegResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new PAWHS_getMemberRegResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new PAWHS_getMemberRegResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new PAWHS_getMemberRegResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new PAWHS_getMemberRegResponseApplicationException(data['ApplicationException']);
        }
    }
}

function PAWHS_getMemberRegResponseApplicationException(data)
{
    /**
...
function PAWHS_getMemberRegResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {PAWHS_getMemberRegResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {PAWHS_getMemberRegResponseAddress} Address
     */
    this['Address'] = null;
    
    /**
     * @member {PAWHS_getMemberRegResponseBank} Bank
     */
    this['Bank'] = null;
    
    /**
     * @member {PAWHS_getMemberRegResponseFIG} FIG
     */
    this['FIG'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new PAWHS_getMemberRegResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Address = [];
            for(Addresschildi = 0; Addresschildi < data.getElementsByTagName("Address").length; Addresschildi++)
            {
                Address.push(new PAWHS_getMemberRegResponseAddress(data.getElementsByTagName("Address")[Addresschildi]));
            }
            ...
            {
                Bank.push(new PAWHS_getMemberRegResponseBank(data.getElementsByTagName("Bank")[Bankchildi]));
            }
            ...
            {
                FIG.push(new PAWHS_getMemberRegResponseFIG(data.getElementsByTagName("FIG")[FIGchildi]));
            }
            ...
            this['Header'] = new PAWHS_getMemberRegResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Address') && data['Address'] != null)
            {
                ...
                {
                    Address.push(new PAWHS_getMemberRegResponseAddress(data['Address'][Addressindex]));
                }
                this['Address'] = Address;
            }
            ...
            if(data.hasOwnProperty('Bank') && data['Bank'] != null)
            {
                ...
                {
                    Bank.push(new PAWHS_getMemberRegResponseBank(data['Bank'][Bankindex]));
                }
                this['Bank'] = Bank;
            }
            ...
            if(data.hasOwnProperty('FIG') && data['FIG'] != null)
            {
                ...
                {
                    FIG.push(new PAWHS_getMemberRegResponseFIG(data['FIG'][FIGindex]));
                }
                this['FIG'] = FIG;
            }
        }
...
function PAWHS_getMemberRegResponseHeader(data)
{
    /**
     * @member {Int32} orgn_rowid
     */
...
function PAWHS_getMemberRegResponseAddress(data)
{
    /**
...
function PAWHS_getMemberRegResponseBank(data)
{
    /**
...
function PAWHS_getMemberRegResponseFIG(data)
{
    /**
