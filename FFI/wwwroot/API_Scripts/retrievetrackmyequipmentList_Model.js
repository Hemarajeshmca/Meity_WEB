...
function retrievetrackmyequipmentListRequest(data)
{
    /**
     * @member {retrievetrackmyequipmentListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrievetrackmyequipmentListRequestcontext(data['context']);
    }
}

function retrievetrackmyequipmentListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrievetrackmyequipmentListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrievetrackmyequipmentListRequestFilter(data['Filter']);
    }
}

function retrievetrackmyequipmentListRequestFilter(data)
{
    /**
...
function retrievetrackmyequipmentListResponse(data, format)
{
    /**
     * @member {retrievetrackmyequipmentListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrievetrackmyequipmentListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrievetrackmyequipmentListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrievetrackmyequipmentListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrievetrackmyequipmentListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrievetrackmyequipmentListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrievetrackmyequipmentListResponseApplicationException(data)
{
    /**
...
function retrievetrackmyequipmentListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrievetrackmyequipmentListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrievetrackmyequipmentListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrievetrackmyequipmentListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrievetrackmyequipmentListResponseList(data)
{
    /**
