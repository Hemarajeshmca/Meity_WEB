...
function retrieveTransferRegisterRequest(data)
{
    /**
     * @member {retrieveTransferRegisterRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveTransferRegisterRequestcontext(data['context']);
    }
}

function retrieveTransferRegisterRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveTransferRegisterRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveTransferRegisterRequestHeader(data['Header']);
    }
}

function retrieveTransferRegisterRequestHeader(data)
{
    /**
...
function retrieveTransferRegisterResponse(data, format)
{
    /**
     * @member {retrieveTransferRegisterResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveTransferRegisterResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveTransferRegisterResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveTransferRegisterResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveTransferRegisterResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveTransferRegisterResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveTransferRegisterResponseApplicationException(data)
{
    /**
...
function retrieveTransferRegisterResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveTransferRegisterResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {retrieveTransferRegisterResponseDetail} Detail
     */
    this['Detail'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveTransferRegisterResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Detail = [];
            for(Detailchildi = 0; Detailchildi < data.getElementsByTagName("Detail").length; Detailchildi++)
            {
                Detail.push(new retrieveTransferRegisterResponseDetail(data.getElementsByTagName("Detail")[Detailchildi]));
            }
            ...
            this['Header'] = new retrieveTransferRegisterResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Detail') && data['Detail'] != null)
            {
                ...
                {
                    Detail.push(new retrieveTransferRegisterResponseDetail(data['Detail'][Detailindex]));
                }
                this['Detail'] = Detail;
            }
        }
...
function retrieveTransferRegisterResponseHeader(data)
{
    /**
...
function retrieveTransferRegisterResponseDetail(data)
{
    /**
