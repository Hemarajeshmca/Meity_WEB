...
function PAWHS_getServiceReceiptListRequest(data)
{
    /**
     * @member {PAWHS_getServiceReceiptListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new PAWHS_getServiceReceiptListRequestcontext(data['context']);
    }
}

function PAWHS_getServiceReceiptListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {PAWHS_getServiceReceiptListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new PAWHS_getServiceReceiptListRequestFilter(data['Filter']);
    }
}

function PAWHS_getServiceReceiptListRequestFilter(data)
{
    /**
...
function PAWHS_getServiceReceiptListResponse(data, format)
{
    /**
     * @member {PAWHS_getServiceReceiptListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {PAWHS_getServiceReceiptListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new PAWHS_getServiceReceiptListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new PAWHS_getServiceReceiptListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new PAWHS_getServiceReceiptListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new PAWHS_getServiceReceiptListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function PAWHS_getServiceReceiptListResponseApplicationException(data)
{
    /**
...
function PAWHS_getServiceReceiptListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {PAWHS_getServiceReceiptListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new PAWHS_getServiceReceiptListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new PAWHS_getServiceReceiptListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function PAWHS_getServiceReceiptListResponseList(data)
{
    /**
