var CreditIssue_CreditIssue_master_savePaymentCollection = {
    /*
    ...
    invoke: function (savePaymentCollection_Request, callbackHandler)
    {
        ...
        WebAPIProxy.invokeAPI("POST", targetURL, requestdata, contentType, responseFormat, null, CreditIssue_CreditIssue_master_savePaymentCollection.savePaymentCollection_ResponseHandler);
        return true;
    },
    ...
    savePaymentCollection_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            ...
            CreditIssue_CreditIssue_master_savePaymentCollection.callbackfunction(savePaymentCollection_ResponseObject, textStatus);
        }
        else {
            CreditIssue_CreditIssue_master_savePaymentCollection.callbackfunction(responseData, textStatus);
        }
    },
