...
function retrieveAttributeGroupListRequest(data)
{
    /**
     * @member {retrieveAttributeGroupListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveAttributeGroupListRequestcontext(data['context']);
    }
}

function retrieveAttributeGroupListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveAttributeGroupListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveAttributeGroupListRequestFilter(data['Filter']);
    }
}

function retrieveAttributeGroupListRequestFilter(data)
{
    /**
...
function retrieveAttributeGroupListResponse(data, format)
{
    /**
     * @member {retrieveAttributeGroupListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveAttributeGroupListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveAttributeGroupListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveAttributeGroupListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveAttributeGroupListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveAttributeGroupListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveAttributeGroupListResponseApplicationException(data)
{
    /**
...
function retrieveAttributeGroupListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveAttributeGroupListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrieveAttributeGroupListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveAttributeGroupListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveAttributeGroupListResponseList(data)
{
    /**
