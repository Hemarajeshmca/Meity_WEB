...
function PAWHS_getWarehouseReceiptListRequest(data)
{
    /**
     * @member {PAWHS_getWarehouseReceiptListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new PAWHS_getWarehouseReceiptListRequestcontext(data['context']);
    }
}

function PAWHS_getWarehouseReceiptListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {PAWHS_getWarehouseReceiptListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new PAWHS_getWarehouseReceiptListRequestFilter(data['Filter']);
    }
}

function PAWHS_getWarehouseReceiptListRequestFilter(data)
{
    /**
...
function PAWHS_getWarehouseReceiptListResponse(data, format)
{
    /**
     * @member {PAWHS_getWarehouseReceiptListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {PAWHS_getWarehouseReceiptListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new PAWHS_getWarehouseReceiptListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new PAWHS_getWarehouseReceiptListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new PAWHS_getWarehouseReceiptListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new PAWHS_getWarehouseReceiptListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function PAWHS_getWarehouseReceiptListResponseApplicationException(data)
{
    /**
...
function PAWHS_getWarehouseReceiptListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {PAWHS_getWarehouseReceiptListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new PAWHS_getWarehouseReceiptListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new PAWHS_getWarehouseReceiptListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function PAWHS_getWarehouseReceiptListResponseList(data)
{
    /**
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['grn'] = (data.getElementsByTagName("grn")[0].lastChild != null) ? data.getElementsByTagName("grn")[0].lastChild.nodeValue : "";
            ...
            this['procurement'] = (data.getElementsByTagName("procurement")[0].lastChild != null) ? data.getElementsByTagName("procurement")[0].lastChild.nodeValue : "";
