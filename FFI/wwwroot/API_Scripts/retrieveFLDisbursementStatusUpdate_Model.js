...
function retrieveFLDisbursementStatusUpdateRequest(data)
{
    /**
     * @member {retrieveFLDisbursementStatusUpdateRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveFLDisbursementStatusUpdateRequestcontext(data['context']);
    }
}

function retrieveFLDisbursementStatusUpdateRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveFLDisbursementStatusUpdateRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveFLDisbursementStatusUpdateRequestFilter(data['Filter']);
    }
}

function retrieveFLDisbursementStatusUpdateRequestFilter(data)
{
    /**
...
function retrieveFLDisbursementStatusUpdateResponse(data, format)
{
    /**
     * @member {retrieveFLDisbursementStatusUpdateResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveFLDisbursementStatusUpdateResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveFLDisbursementStatusUpdateResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveFLDisbursementStatusUpdateResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveFLDisbursementStatusUpdateResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveFLDisbursementStatusUpdateResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveFLDisbursementStatusUpdateResponseApplicationException(data)
{
    /**
...
function retrieveFLDisbursementStatusUpdateResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveFLDisbursementStatusUpdateResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrieveFLDisbursementStatusUpdateResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveFLDisbursementStatusUpdateResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveFLDisbursementStatusUpdateResponseList(data)
{
    /**
