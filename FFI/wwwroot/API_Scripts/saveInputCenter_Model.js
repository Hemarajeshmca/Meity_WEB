...
function saveInputCenterRequest(data)
{
    /**
     * @member {saveInputCenterRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new saveInputCenterRequestcontext(data['context']);
    }
}

function saveInputCenterRequestcontext(data)
{
    /**
    ...
    /**
     * @member {saveInputCenterRequestHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {saveInputCenterRequestAddress} Address
     */
    this['Address'] = null;
    
    /**
     * @member {saveInputCenterRequestBank} Bank
     */
    this['Bank'] = null;
    
    /**
     * @member {saveInputCenterRequestUser} User
     */
    this['User'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new saveInputCenterRequestHeader(data['Header']);
        ...
        if(data.hasOwnProperty('Address') && data['Address'] != null)
        {
            ...
            {
                Address.push(new saveInputCenterRequestAddress(data['Address'][Addressindex]));
            }
        ...
        if(data.hasOwnProperty('Bank') && data['Bank'] != null)
        {
            ...
            {
                Bank.push(new saveInputCenterRequestBank(data['Bank'][Bankindex]));
            }
            this['Bank'] = Bank;
        }
        ...
        if(data.hasOwnProperty('User') && data['User'] != null)
        {
            ...
            {
                User.push(new saveInputCenterRequestUser(data['User'][Userindex]));
            }
            this['User'] = User;
        }
    }
...
function saveInputCenterRequestHeader(data)
{
    /**
    ...
    /**
     * @member {String} inputcenter_code
     */
    this['inputcenter_code'] = null;
    
    /**
     * @member {String} inputcenter_type
     */
    this['inputcenter_type'] = null;
    
    /**
     * @member {String} inputcenter_name
     */
    this['inputcenter_name'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('inputcenter_code'))
            this['inputcenter_code'] = data['inputcenter_code'];
        
        if(data.hasOwnProperty('inputcenter_type'))
            this['inputcenter_type'] = data['inputcenter_type'];
        
        if(data.hasOwnProperty('inputcenter_name'))
            this['inputcenter_name'] = data['inputcenter_name'];
...
function saveInputCenterRequestAddress(data)
{
    /**
...
function saveInputCenterRequestBank(data)
{
    /**
...
function saveInputCenterRequestUser(data)
{
    /**
...
function saveInputCenterResponse(data, format)
{
    /**
     * @member {saveInputCenterResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {saveInputCenterResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new saveInputCenterResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new saveInputCenterResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new saveInputCenterResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new saveInputCenterResponseApplicationException(data['ApplicationException']);
        }
    }
}

function saveInputCenterResponseApplicationException(data)
{
    /**
...
function saveInputCenterResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {saveInputCenterResponseHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new saveInputCenterResponseHeader(data.getElementsByTagName("Header")[0]);
        }
        else {
            this['orgnId'] = data['orgnId'];
            ...
            this['Header'] = new saveInputCenterResponseHeader(data['Header']);
        }
    }
}

function saveInputCenterResponseHeader(data)
{
    /**
     * @member {Int32} orgn_rowid
     */
