var MilkReciptsCP_milk_receipt_defaultfetch = {
    /*
    ...
    invoke: function (defaultfetch_Request, callbackHandler)
    {
        ...
        var param_cpsession_rowid = (defaultfetch_Request.context.Header && defaultfetch_Request.context.Header.hasOwnProperty('cpsession_rowid')) ? defaultfetch_Request.context.Header["cpsession_rowid"] : null; //Integer(32)
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/MilkReciptsCP/default?org=" + param_orgnid + "&locn=" + param_locnid + "&user=" + param_userid + "&lang=" + param_localeid + "&cpsession_rowid=" + param_cpsession_rowid + "&cp_aggrloc_code=" + param_cp_aggrloc_code + "&cc_aggrloc_code=" + param_cc_aggrloc_code + "";
        
        WebAPIProxy.invokeAPI("GET", targetURL, null, contentType, responseFormat, null, MilkReciptsCP_milk_receipt_defaultfetch.defaultfetch_ResponseHandler);
        return true;
    },
    ...
    defaultfetch_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            ...
            MilkReciptsCP_milk_receipt_defaultfetch.callbackfunction(defaultfetch_ResponseObject, textStatus);
        }
        else {
            MilkReciptsCP_milk_receipt_defaultfetch.callbackfunction(responseData, textStatus);
        }
    },
