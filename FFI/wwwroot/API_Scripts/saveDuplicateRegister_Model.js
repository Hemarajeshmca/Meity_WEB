...
function saveDuplicateRegisterRequest(data)
{
    /**
     * @member {saveDuplicateRegisterRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new saveDuplicateRegisterRequestcontext(data['context']);
    }
}

function saveDuplicateRegisterRequestcontext(data)
{
    /**
    ...
    /**
     * @member {saveDuplicateRegisterRequestHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {saveDuplicateRegisterRequestDetail} Detail
     */
    this['Detail'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new saveDuplicateRegisterRequestHeader(data['Header']);
        ...
        if(data.hasOwnProperty('Detail') && data['Detail'] != null)
        {
            ...
            {
                Detail.push(new saveDuplicateRegisterRequestDetail(data['Detail'][Detailindex]));
            }
            this['Detail'] = Detail;
        }
    }
...
function saveDuplicateRegisterRequestHeader(data)
{
    /**
...
function saveDuplicateRegisterRequestDetail(data)
{
    /**
...
function saveDuplicateRegisterResponse(data, format)
{
    /**
     * @member {saveDuplicateRegisterResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {saveDuplicateRegisterResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new saveDuplicateRegisterResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new saveDuplicateRegisterResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new saveDuplicateRegisterResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new saveDuplicateRegisterResponseApplicationException(data['ApplicationException']);
        }
    }
}

function saveDuplicateRegisterResponseApplicationException(data)
{
    /**
...
function saveDuplicateRegisterResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {saveDuplicateRegisterResponseHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new saveDuplicateRegisterResponseHeader(data.getElementsByTagName("Header")[0]);
        }
        else {
            this['orgnId'] = data['orgnId'];
            ...
            this['Header'] = new saveDuplicateRegisterResponseHeader(data['Header']);
        }
    }
}

function saveDuplicateRegisterResponseHeader(data)
{
    /**
     * @member {Int16} register_rowid
     */
