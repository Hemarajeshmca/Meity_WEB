...
function PAWHS_getStockAdjustmentListRequest(data)
{
    /**
     * @member {PAWHS_getStockAdjustmentListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new PAWHS_getStockAdjustmentListRequestcontext(data['context']);
    }
}

function PAWHS_getStockAdjustmentListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {PAWHS_getStockAdjustmentListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new PAWHS_getStockAdjustmentListRequestFilter(data['Filter']);
    }
}

function PAWHS_getStockAdjustmentListRequestFilter(data)
{
    /**
...
function PAWHS_getStockAdjustmentListResponse(data, format)
{
    /**
     * @member {PAWHS_getStockAdjustmentListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {PAWHS_getStockAdjustmentListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new PAWHS_getStockAdjustmentListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new PAWHS_getStockAdjustmentListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new PAWHS_getStockAdjustmentListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new PAWHS_getStockAdjustmentListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function PAWHS_getStockAdjustmentListResponseApplicationException(data)
{
    /**
...
function PAWHS_getStockAdjustmentListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {PAWHS_getStockAdjustmentListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new PAWHS_getStockAdjustmentListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new PAWHS_getStockAdjustmentListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function PAWHS_getStockAdjustmentListResponseList(data)
{
    /**
