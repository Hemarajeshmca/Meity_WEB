...
function getInvoiceGenerationListRequest(data)
{
    /**
     * @member {getInvoiceGenerationListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new getInvoiceGenerationListRequestcontext(data['context']);
    }
}

function getInvoiceGenerationListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {getInvoiceGenerationListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new getInvoiceGenerationListRequestFilter(data['Filter']);
    }
}

function getInvoiceGenerationListRequestFilter(data)
{
    /**
...
function getInvoiceGenerationListResponse(data, format)
{
    /**
     * @member {getInvoiceGenerationListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {getInvoiceGenerationListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new getInvoiceGenerationListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new getInvoiceGenerationListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new getInvoiceGenerationListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new getInvoiceGenerationListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function getInvoiceGenerationListResponseApplicationException(data)
{
    /**
...
function getInvoiceGenerationListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {getInvoiceGenerationListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new getInvoiceGenerationListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new getInvoiceGenerationListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function getInvoiceGenerationListResponseList(data)
{
    /**
