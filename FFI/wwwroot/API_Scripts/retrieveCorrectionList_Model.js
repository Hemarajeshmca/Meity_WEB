...
function retrieveCorrectionListRequest(data)
{
    /**
     * @member {retrieveCorrectionListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveCorrectionListRequestcontext(data['context']);
    }
}

function retrieveCorrectionListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveCorrectionListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveCorrectionListRequestFilter(data['Filter']);
    }
}

function retrieveCorrectionListRequestFilter(data)
{
    /**
...
function retrieveCorrectionListResponse(data, format)
{
    /**
     * @member {retrieveCorrectionListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveCorrectionListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveCorrectionListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveCorrectionListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveCorrectionListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveCorrectionListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveCorrectionListResponseApplicationException(data)
{
    /**
...
function retrieveCorrectionListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveCorrectionListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrieveCorrectionListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveCorrectionListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveCorrectionListResponseList(data)
{
    /**
    ...
    /**
     * @member {String} correction_purpose
     */
    this['correction_purpose'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['correction_purpose'] = (data.getElementsByTagName("correction_purpose")[0].lastChild != null) ? data.getElementsByTagName("correction_purpose")[0].lastChild.nodeValue : "";
            ...
            this['correction_purpose'] = data['correction_purpose'];
