...
function saveAggregatorOrgsRequest(data)
{
    /**
     * @member {saveAggregatorOrgsRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new saveAggregatorOrgsRequestcontext(data['context']);
    }
}

function saveAggregatorOrgsRequestcontext(data)
{
    /**
    ...
    /**
     * @member {saveAggregatorOrgsRequestHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {saveAggregatorOrgsRequestAddress} Address
     */
    this['Address'] = null;
    
    /**
     * @member {saveAggregatorOrgsRequestBank} Bank
     */
    this['Bank'] = null;
    
    /**
     * @member {saveAggregatorOrgsRequestUser} User
     */
    this['User'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new saveAggregatorOrgsRequestHeader(data['Header']);
        ...
        if(data.hasOwnProperty('Address') && data['Address'] != null)
        {
            ...
            {
                Address.push(new saveAggregatorOrgsRequestAddress(data['Address'][Addressindex]));
            }
        ...
        if(data.hasOwnProperty('Bank') && data['Bank'] != null)
        {
            ...
            {
                Bank.push(new saveAggregatorOrgsRequestBank(data['Bank'][Bankindex]));
            }
            this['Bank'] = Bank;
        }
        ...
        if(data.hasOwnProperty('User') && data['User'] != null)
        {
            ...
            {
                User.push(new saveAggregatorOrgsRequestUser(data['User'][Userindex]));
            }
            this['User'] = User;
        }
    }
...
function saveAggregatorOrgsRequestHeader(data)
{
    /**
...
function saveAggregatorOrgsRequestAddress(data)
{
    /**
...
function saveAggregatorOrgsRequestBank(data)
{
    /**
...
function saveAggregatorOrgsRequestUser(data)
{
    /**
...
function saveAggregatorOrgsResponse(data, format)
{
    /**
     * @member {saveAggregatorOrgsResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {saveAggregatorOrgsResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new saveAggregatorOrgsResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new saveAggregatorOrgsResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new saveAggregatorOrgsResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new saveAggregatorOrgsResponseApplicationException(data['ApplicationException']);
        }
    }
}

function saveAggregatorOrgsResponseApplicationException(data)
{
    /**
...
function saveAggregatorOrgsResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {saveAggregatorOrgsResponseHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new saveAggregatorOrgsResponseHeader(data.getElementsByTagName("Header")[0]);
        }
        else {
            this['orgnId'] = data['orgnId'];
            ...
            this['Header'] = new saveAggregatorOrgsResponseHeader(data['Header']);
        }
    }
}

function saveAggregatorOrgsResponseHeader(data)
{
    /**
     * @member {Int32} orgn_rowid
     */
