var ShareApplication_Share_App_retrieveProcessShareAppList = {
    /*
    ...
    invoke: function (retrieveProcessShareAppList_Request, callbackHandler)
    {
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/ShareApplication/all_process?org=" + param_orgnid + "&locn=" + param_locnid + "&user=" + param_userid + "&lang=" + param_localeid + "&filterby_option=" + param_filterby_option + "&filterby_code=" + param_filterby_code + "&filterby_fromvalue=" + param_filterby_fromvalue + "&filterby_tovalue=" + param_filterby_tovalue + "";
        
        WebAPIProxy.invokeAPI("GET", targetURL, null, contentType, responseFormat, null, ShareApplication_Share_App_retrieveProcessShareAppList.retrieveProcessShareAppList_ResponseHandler);
        return true;
    },
    ...
    retrieveProcessShareAppList_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            var retrieveProcessShareAppList_ResponseObject = new retrieveProcessShareAppListResponse(responseData, "JSON");
            ShareApplication_Share_App_retrieveProcessShareAppList.callbackfunction(retrieveProcessShareAppList_ResponseObject, textStatus);
        }
        else {
            ShareApplication_Share_App_retrieveProcessShareAppList.callbackfunction(responseData, textStatus);
        }
    },
