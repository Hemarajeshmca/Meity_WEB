...
function retrieveProcessFarmerLoanAppRequest(data)
{
    /**
     * @member {retrieveProcessFarmerLoanAppRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveProcessFarmerLoanAppRequestcontext(data['context']);
    }
}

function retrieveProcessFarmerLoanAppRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveProcessFarmerLoanAppRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveProcessFarmerLoanAppRequestHeader(data['Header']);
    }
}

function retrieveProcessFarmerLoanAppRequestHeader(data)
{
    /**
...
function retrieveProcessFarmerLoanAppResponse(data, format)
{
    /**
     * @member {retrieveProcessFarmerLoanAppResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveProcessFarmerLoanAppResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveProcessFarmerLoanAppResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveProcessFarmerLoanAppResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveProcessFarmerLoanAppResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveProcessFarmerLoanAppResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveProcessFarmerLoanAppResponseApplicationException(data)
{
    /**
...
function retrieveProcessFarmerLoanAppResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveProcessFarmerLoanAppResponseHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveProcessFarmerLoanAppResponseHeader(data.getElementsByTagName("Header")[0]);
        }
        else {
            this['orgnId'] = data['orgnId'];
            ...
            this['Header'] = new retrieveProcessFarmerLoanAppResponseHeader(data['Header']);
        }
    }
}

function retrieveProcessFarmerLoanAppResponseHeader(data)
{
    /**
