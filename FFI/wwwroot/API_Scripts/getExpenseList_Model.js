...
function getExpenseListRequest(data)
{
    /**
     * @member {getExpenseListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new getExpenseListRequestcontext(data['context']);
    }
}

function getExpenseListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {getExpenseListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new getExpenseListRequestFilter(data['Filter']);
    }
}

function getExpenseListRequestFilter(data)
{
    /**
...
function getExpenseListResponse(data, format)
{
    /**
     * @member {getExpenseListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {getExpenseListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new getExpenseListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new getExpenseListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new getExpenseListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new getExpenseListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function getExpenseListResponseApplicationException(data)
{
    /**
...
function getExpenseListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {getExpenseListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new getExpenseListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new getExpenseListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function getExpenseListResponseList(data)
{
    /**
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['total_expenses'] = data.getElementsByTagName("total_expenses")[0].lastChild.nodeValue;
            ...
            this['total_expenses'] = data['total_expenses'].toFixed(2);
