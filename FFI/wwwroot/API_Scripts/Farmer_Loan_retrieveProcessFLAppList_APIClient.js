var FarmerLoan_Farmer_Loan_retrieveProcessFLAppList = {
    /*
     Function to invoke API
     Notes:
     Resource: Farmer_Loan
     Description: retrieveProcessFLAppList
     Http verb: GET
    ...
    invoke: function (retrieveProcessFarmerLoanAppList_Request, callbackHandler)
    {
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/FarmerLoan/allprocess_farmer_loan?org=" + param_orgnid + "&locn=" + param_locnid + "&user=" + param_userid + "&lang=" + param_localeid + "&filterby_option=" + param_filterby_option + "&filterby_code=" + param_filterby_code + "&filterby_fromvalue=" + param_filterby_fromvalue + "&filterby_tovalue=" + param_filterby_tovalue + "";
        
        WebAPIProxy.invokeAPI("GET", targetURL, null, contentType, responseFormat, null, FarmerLoan_Farmer_Loan_retrieveProcessFLAppList.retrieveProcessFLAppList_ResponseHandler);
        return true;
    },
    
    retrieveProcessFLAppList_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            var retrieveProcessFarmerLoanAppList_ResponseObject = new retrieveProcessFarmerLoanAppListResponse(responseData, "JSON");
            FarmerLoan_Farmer_Loan_retrieveProcessFLAppList.callbackfunction(retrieveProcessFarmerLoanAppList_ResponseObject, textStatus);
        }
        else {
            FarmerLoan_Farmer_Loan_retrieveProcessFLAppList.callbackfunction(responseData, textStatus);
        }
    },
