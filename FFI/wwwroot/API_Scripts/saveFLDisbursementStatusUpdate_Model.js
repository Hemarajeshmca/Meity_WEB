...
function saveFLDisbursementStatusUpdateRequest(data)
{
    /**
     * @member {saveFLDisbursementStatusUpdateRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new saveFLDisbursementStatusUpdateRequestcontext(data['context']);
    }
}

function saveFLDisbursementStatusUpdateRequestcontext(data)
{
    /**
    ...
    /**
     * @member {saveFLDisbursementStatusUpdateRequestFilter} Filter
     */
    this['Filter'] = null;
    
    /**
     * @member {saveFLDisbursementStatusUpdateRequestList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new saveFLDisbursementStatusUpdateRequestFilter(data['Filter']);
        ...
        if(data.hasOwnProperty('List') && data['List'] != null)
        {
            ...
            {
                List.push(new saveFLDisbursementStatusUpdateRequestList(data['List'][Listindex]));
            }
            this['List'] = List;
        }
    }
...
function saveFLDisbursementStatusUpdateRequestFilter(data)
{
    /**
...
function saveFLDisbursementStatusUpdateRequestList(data)
{
    /**
...
function saveFLDisbursementStatusUpdateResponse(data, format)
{
    /**
     * @member {saveFLDisbursementStatusUpdateResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {saveFLDisbursementStatusUpdateResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new saveFLDisbursementStatusUpdateResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new saveFLDisbursementStatusUpdateResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new saveFLDisbursementStatusUpdateResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new saveFLDisbursementStatusUpdateResponseApplicationException(data['ApplicationException']);
        }
    }
}

function saveFLDisbursementStatusUpdateResponseApplicationException(data)
{
    /**
...
function saveFLDisbursementStatusUpdateResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
