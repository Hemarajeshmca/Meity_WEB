...
function retrieveRegisterListRequest(data)
{
    /**
     * @member {retrieveRegisterListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveRegisterListRequestcontext(data['context']);
    }
}

function retrieveRegisterListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveRegisterListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveRegisterListRequestFilter(data['Filter']);
    }
}

function retrieveRegisterListRequestFilter(data)
{
    /**
...
function retrieveRegisterListResponse(data, format)
{
    /**
     * @member {retrieveRegisterListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveRegisterListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveRegisterListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveRegisterListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveRegisterListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveRegisterListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveRegisterListResponseApplicationException(data)
{
    /**
...
function retrieveRegisterListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveRegisterListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrieveRegisterListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveRegisterListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveRegisterListResponseList(data)
{
    /**
