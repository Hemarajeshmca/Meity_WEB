...
function retrieveFLRecoveryBounceRequest(data)
{
    /**
     * @member {retrieveFLRecoveryBounceRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveFLRecoveryBounceRequestcontext(data['context']);
    }
}

function retrieveFLRecoveryBounceRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveFLRecoveryBounceRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new retrieveFLRecoveryBounceRequestHeader(data['Header']);
    }
}

function retrieveFLRecoveryBounceRequestHeader(data)
{
    /**
...
function retrieveFLRecoveryBounceResponse(data, format)
{
    /**
     * @member {retrieveFLRecoveryBounceResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveFLRecoveryBounceResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveFLRecoveryBounceResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveFLRecoveryBounceResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveFLRecoveryBounceResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveFLRecoveryBounceResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveFLRecoveryBounceResponseApplicationException(data)
{
    /**
...
function retrieveFLRecoveryBounceResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveFLRecoveryBounceResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {retrieveFLRecoveryBounceResponseDetail} Detail
     */
    this['Detail'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new retrieveFLRecoveryBounceResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Detail = [];
            for(Detailchildi = 0; Detailchildi < data.getElementsByTagName("Detail").length; Detailchildi++)
            {
                Detail.push(new retrieveFLRecoveryBounceResponseDetail(data.getElementsByTagName("Detail")[Detailchildi]));
            }
            ...
            this['Header'] = new retrieveFLRecoveryBounceResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Detail') && data['Detail'] != null)
            {
                ...
                {
                    Detail.push(new retrieveFLRecoveryBounceResponseDetail(data['Detail'][Detailindex]));
                }
                this['Detail'] = Detail;
            }
        }
...
function retrieveFLRecoveryBounceResponseHeader(data)
{
    /**
     * @member {String} fig_short_name
     */
...
function retrieveFLRecoveryBounceResponseDetail(data)
{
    /**
     * @member {String} fig_short_name
     */
