...
function PAWHS_getReadyToPickupListRequest(data)
{
    /**
     * @member {PAWHS_getReadyToPickupListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new PAWHS_getReadyToPickupListRequestcontext(data['context']);
    }
}

function PAWHS_getReadyToPickupListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {PAWHS_getReadyToPickupListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new PAWHS_getReadyToPickupListRequestFilter(data['Filter']);
    }
}

function PAWHS_getReadyToPickupListRequestFilter(data)
{
    /**
...
function PAWHS_getReadyToPickupListResponse(data, format)
{
    /**
     * @member {PAWHS_getReadyToPickupListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {PAWHS_getReadyToPickupListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new PAWHS_getReadyToPickupListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new PAWHS_getReadyToPickupListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new PAWHS_getReadyToPickupListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new PAWHS_getReadyToPickupListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function PAWHS_getReadyToPickupListResponseApplicationException(data)
{
    /**
...
function PAWHS_getReadyToPickupListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {PAWHS_getReadyToPickupListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new PAWHS_getReadyToPickupListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new PAWHS_getReadyToPickupListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function PAWHS_getReadyToPickupListResponseList(data)
{
    /**
