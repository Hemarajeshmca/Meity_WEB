...
function defaultfetchRequest(data)
{
    /**
     * @member {defaultfetchRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new defaultfetchRequestcontext(data['context']);
    }
}

function defaultfetchRequestcontext(data)
{
    /**
    ...
    /**
     * @member {defaultfetchRequestHeader} Header
     */
    this['Header'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Header') && data['Header'] != null)
            this['Header'] = new defaultfetchRequestHeader(data['Header']);
    }
}

function defaultfetchRequestHeader(data)
{
    /**
...
function defaultfetchResponse(data, format)
{
    /**
     * @member {defaultfetchResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {defaultfetchResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new defaultfetchResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new defaultfetchResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new defaultfetchResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new defaultfetchResponseApplicationException(data['ApplicationException']);
        }
    }
}

function defaultfetchResponseApplicationException(data)
{
    /**
...
function defaultfetchResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {defaultfetchResponseHeader} Header
     */
    this['Header'] = null;
    
    /**
     * @member {defaultfetchResponseDetail} Detail
     */
    this['Detail'] = null;
    
    /**
     * @member {defaultfetchResponsesummary} summary
     */
    this['summary'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Header'] = new defaultfetchResponseHeader(data.getElementsByTagName("Header")[0]);
            
            Detail = [];
            for(Detailchildi = 0; Detailchildi < data.getElementsByTagName("Detail").length; Detailchildi++)
            {
                Detail.push(new defaultfetchResponseDetail(data.getElementsByTagName("Detail")[Detailchildi]));
            }
            ...
            {
                summary.push(new defaultfetchResponsesummary(data.getElementsByTagName("summary")[summarychildi]));
            }
            ...
            this['Header'] = new defaultfetchResponseHeader(data['Header']);
            ...
            if(data.hasOwnProperty('Detail') && data['Detail'] != null)
            {
                ...
                {
                    Detail.push(new defaultfetchResponseDetail(data['Detail'][Detailindex]));
                }
                this['Detail'] = Detail;
            }
            ...
            if(data.hasOwnProperty('summary') && data['summary'] != null)
            {
                ...
                {
                    summary.push(new defaultfetchResponsesummary(data['summary'][summaryindex]));
                }
                this['summary'] = summary;
            }
        }
...
function defaultfetchResponseHeader(data)
{
    /**
     * @member {Int32} cpsession_rowid
     */
...
function defaultfetchResponseDetail(data)
{
    /**
...
function defaultfetchResponsesummary(data)
{
    /**
