...
function retrieveFarmerProfileListRequest(data)
{
    /**
     * @member {retrieveFarmerProfileListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveFarmerProfileListRequestcontext(data['context']);
    }
}

function retrieveFarmerProfileListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveFarmerProfileListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveFarmerProfileListRequestFilter(data['Filter']);
    }
}

function retrieveFarmerProfileListRequestFilter(data)
{
    /**
...
function retrieveFarmerProfileListResponse(data, format)
{
    /**
     * @member {retrieveFarmerProfileListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveFarmerProfileListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveFarmerProfileListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveFarmerProfileListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveFarmerProfileListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveFarmerProfileListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveFarmerProfileListResponseApplicationException(data)
{
    /**
...
function retrieveFarmerProfileListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveFarmerProfileListResponseFilter} Filter
     */
    this['Filter'] = null;
    
    /**
     * @member {retrieveFarmerProfileListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['Filter'] = new retrieveFarmerProfileListResponseFilter(data.getElementsByTagName("Filter")[0]);
            
            List = [];
            for(Listchildi = 0; Listchildi < data.getElementsByTagName("List").length; Listchildi++)
            {
                List.push(new retrieveFarmerProfileListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            this['Filter'] = new retrieveFarmerProfileListResponseFilter(data['Filter']);
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveFarmerProfileListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveFarmerProfileListResponseFilter(data)
{
    /**
     * @member {Int16} record_count
     */
...
function retrieveFarmerProfileListResponseList(data)
{
    /**
