function retrieve_StockAdjustment_list(FilterrequestObject) {
    PAWHSStockAdjustment_PAWHS_StockAdjustment_PAWHS_getStockAdjustmentList.invoke(FilterrequestObject, retrieve_StockAdjustment_listAPI_ResponseHandler);
}
...
function retrieve_StockAdjustment_details(HeaderrequestObject) {
    PAWHSStockAdjustment_PAWHS_StockAdjustment_PAWHS_getStockAdjustment.invoke(HeaderrequestObject, retrieve_StockAdjustmentscreenAPI_ResponseHandler);
}
...
function save_StockAdjustment_details(HeaderrequestObject) {
    PAWHSStockAdjustment_PAWHS_StockAdjustment_PAWHS_saveStockAdjustment.invoke(HeaderrequestObject, save_StockAdjustmentAPI_ResponseHandler)
}
