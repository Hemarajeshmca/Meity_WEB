...
function retrieveFLDisbursementListRequest(data)
{
    /**
     * @member {retrieveFLDisbursementListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveFLDisbursementListRequestcontext(data['context']);
    }
}

function retrieveFLDisbursementListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveFLDisbursementListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveFLDisbursementListRequestFilter(data['Filter']);
    }
}

function retrieveFLDisbursementListRequestFilter(data)
{
    /**
...
function retrieveFLDisbursementListResponse(data, format)
{
    /**
     * @member {retrieveFLDisbursementListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveFLDisbursementListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveFLDisbursementListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveFLDisbursementListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveFLDisbursementListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveFLDisbursementListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveFLDisbursementListResponseApplicationException(data)
{
    /**
...
function retrieveFLDisbursementListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveFLDisbursementListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrieveFLDisbursementListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveFLDisbursementListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveFLDisbursementListResponseList(data)
{
    /**
    ...
    /**
     * @member {String} disbursement_Ref_No
     */
    this['disbursement_Ref_No'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            this['disbursement_Ref_No'] = (data.getElementsByTagName("disbursement_Ref_No")[0].lastChild != null) ? data.getElementsByTagName("disbursement_Ref_No")[0].lastChild.nodeValue : "";
            ...
            this['disbursement_Ref_No'] = data['disbursement_Ref_No'];
