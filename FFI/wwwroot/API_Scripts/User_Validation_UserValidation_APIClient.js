var Login_User_Validation_UserValidation = {
    /*
    ...
    invoke: function (UserValidation_Request, callbackHandler)
    {
        ...
        var targetURL = WebAPIProxy.getWebURL() + "/api/Login/user_validation?org=" + param_orgnid + "&locn=" + param_locnid + "&user=" + param_userid + "&lang=" + param_localeid + "&user_code=" + param_user_code + "&user_pwd=" + param_user_pwd + "&mobile_no=" + param_mobile_no + "";
        
        WebAPIProxy.invokeAPI("GET", targetURL, null, contentType, responseFormat, null, Login_User_Validation_UserValidation.UserValidation_ResponseHandler);
        return true;
    },
    ...
    UserValidation_ResponseHandler: function (responseData, textStatus)
    {
        if (textStatus == "success") {
            ...
            Login_User_Validation_UserValidation.callbackfunction(UserValidation_ResponseObject, textStatus);
        }
        else {
            Login_User_Validation_UserValidation.callbackfunction(responseData, textStatus);
        }
    },
