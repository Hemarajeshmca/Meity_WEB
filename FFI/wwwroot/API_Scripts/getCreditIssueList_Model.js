...
function getCreditIssueListRequest(data)
{
    /**
     * @member {getCreditIssueListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new getCreditIssueListRequestcontext(data['context']);
    }
}

function getCreditIssueListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {getCreditIssueListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new getCreditIssueListRequestFilter(data['Filter']);
    }
}

function getCreditIssueListRequestFilter(data)
{
    /**
...
function getCreditIssueListResponse(data, format)
{
    /**
     * @member {getCreditIssueListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {getCreditIssueListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new getCreditIssueListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new getCreditIssueListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new getCreditIssueListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new getCreditIssueListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function getCreditIssueListResponseApplicationException(data)
{
    /**
...
function getCreditIssueListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {getCreditIssueListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new getCreditIssueListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new getCreditIssueListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function getCreditIssueListResponseList(data)
{
    /**
    ...
    /**
     * @member {String} reciver_address
     */
    this['reciver_address'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            if(data.getElementsByTagName("reciver_address")[0].attributes.length == 0) //Check NULL value
                this['reciver_address'] = (data.getElementsByTagName("reciver_address")[0].lastChild != null) ? data.getElementsByTagName("reciver_address")[0].lastChild.nodeValue : "";
            ...
            this['reciver_address'] = data['reciver_address'];
