...
function retrieveFPORegListRequest(data)
{
    /**
     * @member {retrieveFPORegListRequestcontext} context
     */
    this['context'] = null;
    ...
    if(data)
    {
        if(data.hasOwnProperty('context') && data['context'] != null)
            this['context'] = new retrieveFPORegListRequestcontext(data['context']);
    }
}

function retrieveFPORegListRequestcontext(data)
{
    /**
    ...
    /**
     * @member {retrieveFPORegListRequestFilter} Filter
     */
    this['Filter'] = null;
    ...
    if(data)
    {
        ...
        if(data.hasOwnProperty('Filter') && data['Filter'] != null)
            this['Filter'] = new retrieveFPORegListRequestFilter(data['Filter']);
    }
}

function retrieveFPORegListRequestFilter(data)
{
    /**
...
function retrieveFPORegListResponse(data, format)
{
    /**
     * @member {retrieveFPORegListResponsecontext} context
     */
    this['context'] = null;
    
    /**
     * @member {retrieveFPORegListResponseApplicationException} ApplicationException
     */
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            if(data.getElementsByTagName("context").length > 0)
                this['context'] = new retrieveFPORegListResponsecontext(data.getElementsByTagName("context")[0]);
            
            if(data.getElementsByTagName("ApplicationException").length > 0)
                this['ApplicationException'] = new retrieveFPORegListResponseApplicationException(data.getElementsByTagName("ApplicationException")[0]);
        }
        else {
            if(data.hasOwnProperty('context') && data['context'] != null)
                this['context'] = new retrieveFPORegListResponsecontext(data['context']);
            
            if(data.hasOwnProperty('ApplicationException') && data['ApplicationException'] != null)
                this['ApplicationException'] = new retrieveFPORegListResponseApplicationException(data['ApplicationException']);
        }
    }
}

function retrieveFPORegListResponseApplicationException(data)
{
    /**
...
function retrieveFPORegListResponsecontext(data)
{
    /**
     * @member {String} orgnId
     */
    ...
    /**
     * @member {retrieveFPORegListResponseList} List
     */
    this['List'] = null;
    ...
    if(data)
    {
        if (responseDataFormat == "XML") {
            ...
            {
                List.push(new retrieveFPORegListResponseList(data.getElementsByTagName("List")[Listchildi]));
            }
            ...
            if(data.hasOwnProperty('List') && data['List'] != null)
            {
                ...
                {
                    List.push(new retrieveFPORegListResponseList(data['List'][Listindex]));
                }
                this['List'] = List;
            }
        }
...
function retrieveFPORegListResponseList(data)
{
    /**
