...
$(document).ready(function () {
    $('#HelpModal').on('show.bs.modal', function (e) {
        ...
        $("#grid_condition .k-grid-content").css("height", "170px");
...
function getGriddata() {
    ...
    try {
        ...
        grid_resultset(JSON.parse(result));
             ...
             colCount = $("#grid_resultset").find('.k-grid-header colgroup > col').length;
            $("#grid_resultset").find('.k-grid-content tbody')
              .append('<tr class="kendo-data-row"><td colspan="' + colCount +
                '" style="text-align:center; padding-top:10px;background-color:#AFE4FA"><b> No records available for the  searched Parameters!!!</b></td></tr>');
            return false;
        }
...
$(document).ready(function () {
    ...
    $('#HelpModal').on('show.bs.modal', function (e) {
        ...
        $("#grid_resultset .k-grid-content").css("height", "180px");
    })
...
function getColumns(data, id) {
    ...
    try {
        ...
        $.each(data[0], function (key, value) {
            ...
            if (col.field == "ProductCategoryCode" || col.field == "ProductSubCategoryCode") {
                col.headerAttributes = { style: "text-align: left;display:none;" };
            }
            else {
