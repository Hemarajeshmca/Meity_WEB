#pragma checksum "D:\Live\Meity\Updated\FEB-06-2023\WEB\meity-web-frontend\FFI\Views\PAWHSNewBookInvoice\PAWHSNewBookInvoicePaymentForm.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9e2ad9bf438fb0c3dcdc8fb7cc14712954d87ca4"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_PAWHSNewBookInvoice_PAWHSNewBookInvoicePaymentForm), @"mvc.1.0.view", @"/Views/PAWHSNewBookInvoice/PAWHSNewBookInvoicePaymentForm.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9e2ad9bf438fb0c3dcdc8fb7cc14712954d87ca4", @"/Views/PAWHSNewBookInvoice/PAWHSNewBookInvoicePaymentForm.cshtml")]
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c20a4f1b02c18b9db37890379beb6b4e8cd0e608", @"/Views/_ViewImports.cshtml")]
    public class Views_PAWHSNewBookInvoice_PAWHSNewBookInvoicePaymentForm : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\Live\Meity\Updated\FEB-06-2023\WEB\meity-web-frontend\FFI\Views\PAWHSNewBookInvoice\PAWHSNewBookInvoicePaymentForm.cshtml"
...
#nullable disable
            WriteLiteral("\r\n<!DOCTYPE html>\r\n<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9e2ad9bf438fb0c3dcdc8fb7cc14712954d87ca45555", async() => {
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9e2ad9bf438fb0c3dcdc8fb7cc14712954d87ca46609", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9e2ad9bf438fb0c3dcdc8fb7cc14712954d87ca46871", async() => {
        ...
        <div class=""modal-body"" style=""height:500px"">
            <div class=""row"" style=""padding-bottom:15px;paddi");
                    WriteLiteral(@"ng-left:20px"">
                <div class=""row"">
                    <div class=""col-sm-6"">
                    ...
                    <div class=""col-sm-6"">
                        <div class=""form-group"">
                            ...
                            <div class=""col-sm-6"">
                                <");
                    WriteLiteral(@"input type=""text"" id=""txtbal_amt"" class=""form-control"" name=""In_balance_amount"" maxlength=""50"" disabled>
  ...
  ");
                ...
                <div class=""row"">
                    ...
                    BeginWriteAttribute("value", " value=\"", 5318, "\"", 5326, 0);
                    EndWriteAttribute();
                    WriteLiteral(@">
...
<script>
        ...
        $('#txtpay_amt').bind(""paste"", function (e) {
            ...
            if ($.isNumeric(text)) {
                if ((text.substring(text.indexOf('.')).length > 3) && (text.indexOf('.') > -1)) {
                    e.preventDefault();
                    $(th");
            WriteLiteral(@"is).val(text.substring(0, text.indexOf('.') + 3));
                }
            }
            else {
                e.preventDefault();
    ...
    function fetch_Invoice_payment() {
        ...
        if (obj_val != undefined) {
         ");
            WriteLiteral(@"   if ($(""#hdn_proc"").val() == ""BIINVOICE"") {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.context != null) {
                            ...
                            generate_Invoice_payment");
            WriteLiteral(@"_Detail(response.context.Detail);
                            var Actual_Date = $(""#txtPay_date"").val().split(""/"")
                            var Required_Date = Actual_Date[2] + '-' + Actual_Date[1] + '-' + Actual_Date[0];
                            var presentDate = new Date(Required_Date);
                            $(function () {
    ...
    function closeModal() {
        ...
        if ($(""#hdn_proc"").val() == ""BIINVOICE"") {
            if ($('#txtbal_amt').val() != '0') {
                ...
                //  $('#invoice_payment').r");
            WriteLiteral(@"emoveClass('modal-open');
                $('#invoice_payment').modal(""hide"");
    ...
    function generate_Invoice_payment_header(res) {
        try {
            if (res != null) {
             ...
             ");
            WriteLiteral(@"   $('#hdnbal_amt').val(HidBalanceAmount);
                ...
                ");
            WriteLiteral(@"    var len = $(""#invoice_form #grid_invoice"").find(""tbody tr"").length;
                    for (var i = 0; i <= len; i++) {
                ...
                if ($(""#hdnbal_amt"").val() != $(""#txtProc_amt"").val()) {
                    ...
                    for (var i = 0; i <= len ; i++) {
                        ...
                        if (model) {//field names
                            ...
                            model.fields[""In_discount_amount""].editable = false;
                            model.fields[""In_tax_amount""].editable = fa");
            WriteLiteral(@"lse;
                            $("".Delete"").attr(""disabled"", false);
                        }
                    }
    ...
    function generate_Invoice_payment_Detail(res) {
        try {
            if (res != null) {
                ...
                gridInvoiceHistory([]);
       ");
            WriteLiteral(@"         //$(""#hdn_mode_flag"").val(""I"");
            }
        }
        catch (err) {
            javascript_log4j_root(arguments.callee.name, err);
        ...
        try {
                    ...
                    schema: {
                        model: {
                            fields: {
                                ...
                                In_payment_mode_d");
            WriteLiteral(@"esc: { type: ""string"", editable: false },
                                In_balance_amount: { type: ""string"", editable: false },
                    ...
                    command: [
            {
                ...
                click: function (e) {
                    ...
                    {
                        field: ""In_p");
            WriteLiteral(@"aymentcollection_rowid"",
...
<script>
 ...
 ");
    ...
    function mandatory() {
        ...
        try {
            ...
            if ($('#cmb_pay').data(""kendoComboBox"").value() == """" || $('#cmb_pay').data(""kendoComboBox"").value() == undefined) {
                ");
            WriteLiteral(@"grid_validate_msg += ""Payment mode cannot be blank <br>"";
                mandatory_check = false;
            }
    ...
    function savepayment() {
        ...
        $(""#txtbal_amt"").prop(""disabled"", false)");
            WriteLiteral(@".removeClass(""k-state-disabled"");
        ...
        $.each(re");
            WriteLiteral(@"sult1, function (index, value) {
        ...
        if ($(""#hdn_proc"").val() == ""BIINVOICE"") {
         ...
         ");
            WriteLiteral(@"       url: ""/PAWHSNewBookInvoice/InvoicePaymentSave"",
                dataType: ""json"",
                contentType: 'application/json; charset=utf-8',
                success: function (response) {
                    ...
                    if (Res.context != null) {
                        ...
                        if (mode == ""I"") {
                            ...
                            get_Invoicepaymen_details(Res.context.Header);
                            f");
            WriteLiteral(@"etch_Invoice_payment();
                            $(""#txtpay_amt"").val(0);
                            $(""#txtRef_no"").val("""");
                        }
                        else {
    ...
    function savegrid() {
      ");
        ...
        if (obj_val.hasOwnProperty('In_pay");
            WriteLiteral(@"ment_date')) {
            if (obj_val.In_payment_date != '' && obj_val.In_payment_date != undefined)
                obj_val.In_payment_date = getFormated_StringDate(obj_val.In_payment_date);
        }
        var grid_val1 = JSON.stringify($(""#grid_Invoice_pay"").data().kendoGrid._data);
                ...
                success: function (response) {
                    ...
                    if (Res.context != null) {
                        ...
                        if (mode == ""I"") {
                            ...
                            get_Invoicepaymen_details(Res.context.Header);
        ");
            WriteLiteral(@"                    fetch_Invoice_payment();
                            $(""#txtpay_amt"").val(0);
                            $(""#txtRef_no"").val("""");
                        }
                        else if (mode == ""D"") {
    ...
    function get_Invoicepaymen_details(res) {
        ...
        if (obj_val != undefined) {
            ...
            $.ajax({
                type: ""POST"",
                da");
            WriteLiteral(@"ta: JSON.stringify({ userId: Context.userId, orgnId: Context.orgnId, locnId: Context.locnId, localeId: Context.localeId, invoice_rowid: Context.Header.invoice_rowid }),
                url: ""/PAWHSNewBookInvoice/InvoicePaymentfetch"",
                dataType: ""json"",
                contentType: 'application/json; charset=utf-8',
                success: function (response) {
