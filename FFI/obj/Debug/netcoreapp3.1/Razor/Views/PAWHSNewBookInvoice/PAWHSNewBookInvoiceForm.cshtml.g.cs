#pragma checksum "D:\Live\Meity\Updated\FEB-06-2023\WEB\meity-web-frontend\FFI\Views\PAWHSNewBookInvoice\PAWHSNewBookInvoiceForm.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "20fdb3dfd1717eca71879b81058b4c962a2130ca"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_PAWHSNewBookInvoice_PAWHSNewBookInvoiceForm), @"mvc.1.0.view", @"/Views/PAWHSNewBookInvoice/PAWHSNewBookInvoiceForm.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"20fdb3dfd1717eca71879b81058b4c962a2130ca", @"/Views/PAWHSNewBookInvoice/PAWHSNewBookInvoiceForm.cshtml")]
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c20a4f1b02c18b9db37890379beb6b4e8cd0e608", @"/Views/_ViewImports.cshtml")]
    public class Views_PAWHSNewBookInvoice_PAWHSNewBookInvoiceForm : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\Live\Meity\Updated\FEB-06-2023\WEB\meity-web-frontend\FFI\Views\PAWHSNewBookInvoice\PAWHSNewBookInvoiceForm.cshtml"
  
    ViewBag.Form = "Book Invoice";
    Layout = "~/Views/Shared/FormViewLayout1.cshtml";

#line default
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "20fdb3dfd1717eca71879b81058b4c962a2130ca7549", async() => {
                WriteLiteral(@"
        ...
        <div class=""row"" style=""padding-bottom:1px;padding-left:15px"">
            <div class=""col-sm-3"">
                <div class="" form-group"">
                    ...
                    <div class="" col-sm-6"">
                        <input id=""buyer_name"" name=""In_buyer_name"" class=""form-control"" readonly>
                        <input hidden id=""buyer_code"" />
                        ...
                        <input type=""hidden"" id=""serail_uid"" name=""serail_uid"">");
                WriteLiteral(@"
                ...
                WriteLiteral(@">
                    ...
                    <a class=""HelpWindow fa fa-search fa-lg"" role=""button"" id=""pay_help1"" data-toggle=""modal"" href=""/HelpFilter/HelpFilter"" hdrtitle=""Member"" searchid=""PAWHSBUYER"" data-target=""#HelpModal"" onclick=transfer(this,""form"","""",""form_control""); title=""Search"" style=""font-size: 19px; ""></a>
                </div>
            </div>
            <div class=""col-sm-3"">
                <div class=""form-group"">
                    <label for=""txt_mobile"" class="" col-sm-4 control-label required"">PO No</label>
                    <div class="" col-sm-6"">
            ...
            <div class=""col-sm-3"">
                <div class="" form-group"">
                    <label for=""invoice_date"" class="" col-sm-4 control-label"">PO Date</label>
                    <div class="" col-sm-6"">
    ...
    <div class=""row"" style=""padding-top:3px;"">
        <section class=""col-md-12"" style=""padding-top:2px;"">
            <div id=""tab_list"" class=""col-md-12"">
                <ul class=""nav n");
                WriteLiteral(@"av-tabs"" style=""border-bottom: 12px solid #fff;"">
                    ...
                    <li style=""width: 8%;"">
                        <a href=""#Transport"" id=""txtTransport"" onclick=""Transport1()"" role=""tab"" data-toggle=""tab"">
                            Transport
                        </a>
                    </li>
                    <li style=""width: 8%;"">
                        <a href=""#Othercost"" id=""txtOthercost"" onclick=""Othercost1()"" role=""tab"" data-toggle=""tab"">
                            Othercost
                        </");
                WriteLiteral(@"a>
                    </li>
                ...
                <div class=""tab-content"">
                    ...
                    <div class=""tab-pane fade active in"" id=""Transport"">
                        <div class=""panel panel-default"">
                     ");
                WriteLiteral(@"       <div class=""panel-body"" style=""padding-bottom:5px"">
                                <div id=""grid_Transport""></div>
                            </div>
                        </div>
                    </div>
    ...
    <div class=""row"" style=""padding-bottom:1px;padding-left:15px"">
        <div class=""col-sm-3"">
            <label for=""cmb_rec_Loca"" class="" col-sm-5 control-label "">Other Cost</label>
            <div class="" col-sm-6"">
                <input id=""txt_transportamt"" name=""In_tranport"" style=""text-align:right"" class=""form-control"" maxlength=""4"" ");
                WriteLiteral(@"onpaste=""return false;"" onkeypress=""return isNumberKey(event)"" value=""0"" readonly>
            </div>
        </div>
        <div class=""col-sm-3"">
            <label for=""cmb_rec_Loca"" class="" col-sm-5 control-label "">Discount Amt</label>
            <div class="" col-sm-6"">
                <input id=""txt_discountamt"" name=""In_discount"" class=""form-control"" style=""text-align:right"" maxlength=""4"" onpaste=""return false;"" onkeypress=""return isNumberKey(event)"" value=""0"">
            </div>
        </div>
        <div class=""col-xs-3"">
            <div class="" form-group"">
                <label for=""invoice_date"" class="" col-sm-5 control-label"">Net Amount</label>
                <div class="" col-sm-6"">
                    <input id=""txt_gross_amount"" name=""In_gross_amount"" style=""text-align:right"" class=""form-control"" maxlength=""6"" onpaste=""return false;"" onkeypress=""return isNumberKey(event)"" readonly>
                </div>
            </div>
        </div>
        <div class=""col-xs-3"">
    ");
                ...
                <label for=""invoice_date"" class="" col-sm-5 control-label"">Gross Amount</label>
                <div class="" col-sm-6"">
                    <input id=""txt_net_amount"" name=""In_net_amount"" style=""text-align:right"" class=""form-control"" maxlength=""6"" onpaste=""return false;"" onkeypress=""return isNumberKey(event)"" readonly>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class=""row"">
        ...
        <div class=""col-sm-3"">
            <div class=""form-group"">
                ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "20fdb3dfd1717eca71879b81058b4c962a2130ca17194", async() => {
...
<script>
    $(document).ready(function () {
        ...
        con");
            WriteLiteral(@"sole.log(securityform);
        setlocalStorage('screen', Screen_Id);
        setlocalStorage(""procrowid"", """");
        setlocalStorage(""process"", ""PWNEWBI"");
      ...
      ");
            WriteLiteral(@"      $(""#hdn_rec_Loc"").val(myComboBox);
        });
        ...
        if (getlocalStorage('btn_clk_val') == ""Edit"") {
            ...
            WriteLiteral(@".userId, orgnId: Context.orgnId, locnId: Context.locnId, localeId: Context.localeId, IOU_invoice_rowid: Context.Header.invoice_rowid }),
                    ...
                    success: function (response) {
                        ...
                        setlocalSt");
            WriteLiteral(@"orage('doc_no', $(""#txtcommon_id"").val());
    ...
    function generate_invoice_header(res) {
        debugger;
        try {
            $(""#buyer_name"").val(res.In_buyer_name);
            ...
            $(""#txt_transportamt"").val(p");
            WriteLiteral(@"arseFloat(res.In_Transport_Amt).toFixed(2));
            ...
            WriteLiteral(@"btnA4Report"").show();
                ...
                for (var i = 0; i <= len; i++) {
                    ...
                    if (model) {//field names
                        ...
                        model.fields[""In_discount_amount""].editable = false;
 ");
            WriteLiteral(@"                       model.fields[""In_tax_amount""].editable = false;
                        $("".Delete"").attr(""disabled"", false);
                    }
                }
            }
        ...
        try {
            if (res != null) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    data[i].In_amount = (pars");
            WriteLiteral(@"eFloat(data[i].In_amount)).toFixed(2);
                    data[i].In_discount_amount = (parseFloat(data[i].In_discount)).toFixed(2);
        ...
        try {
            ...
            WriteLiteral(@"x_data"", data);
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    dataItem.set(""In_tax_rate"", data[i].In_tax_ra");
            WriteLiteral(@"te);
                }
                gridtax(data);
            }
    ...
    $(""#Invoice1"").focusout(function () {
        ...
        var trran = $(""#txt_gross_amount"").val();
        ...
        $(""#txt_net");
            WriteLiteral(@"_amount"").val(parseFloat(total_amount).toFixed(2));
    });
    ...
    $(""#txt_discountamt"").focusout(function () {
        ...
        var trran = $(""#txt_transportamt"").val();
        var total_amou");
            WriteLiteral(@"nt = (parseFloat(inv) + parseFloat(trran)).toFixed(2);
        $(""#txt_net_amount"").val(parseFloat(total_amount).toFixed(2));
    ...
    $(""#txt_discountamt"").mouseleave(function () {
        var inv = $(""#txt_gross_amount"").val();
        var trran = $(""#txt_transportamt"").val();
        var total_amount = (parseFloat(inv) + parseFloat(trran)).t");
    ...
    function generate_invoice_transportdetail(res) {
        debugger;
        try {
            if (res != null) {
                var data = changedataType(res);
...
<script>
    ...
    $(""#txtdtl"").click(function () {
        ...
        if (sourcegrid._data.length > 0 && destinatio");
            WriteLiteral(@"ngrid._data.length > 0) {
...
<script>
        ...
        try {
                    ...
                    schema: {
                        model: {
                            fields: {
                                ...
                                In_qty: { type: """);
            WriteLiteral(@"string"", defaultValue: ""0"" },
                ...
                //toolbar: ""<a class='k-grid-add' id='btnSave' href=''><span class='fa fa-plus' style='color:B");
            WriteLiteral(@"lack'></span></a>"",
                ...
                save: function (data) {
                    ...
                    if (data.values.In_qty) {
                        ...
                        //var amt = (data.model.product_amount != undefined ? parseFloat(data.model.product_amount) : parseFloat(0.0)) - (data.model.discount_");
            WriteLiteral(@"amount != undefined ? parseFloat(data.model.discount_amount) : parseFloat(0.0));
                    ...
                    if (data.values.In_rate) {
                        ...
                        var amt = parseFloat(prd_amt).toFixed(2)
                        var amt1 = parseFloat(prd_amt).toFixed(2)
                        //var amt = (data.model.product_amount != undefined ? parseFloat(data.model.product_amount) : parseFloat(0.0)) - (data.model.discount_amount != undefined ? parseFloat(data.model.discount_amo");
            WriteLiteral(@"unt) : parseFloat(0.0));
                        data.model.set(""In_tax_amount"", ((parseFloat(amt1) * parseFloat(data.model.In_tax_rate)) / 100.0).toFixed(2));
                        data.model.set(""In_net_amount"", (parseFloat(amt) + parseFloat(data.model.In_tax_amount)).toFixed(2));
                    }
            ...
            WriteLiteral(@"qty"",
...

                {
                    ...
                    editor: function (container, options) {
                        item_rate(containe");
            WriteLiteral(@"r, options.field, '9', '2');
            ...
            WriteLiteral(@"
                ...
                {
                    f");
            WriteLiteral(@"ield: ""In_mode_flag"",
                    title: ""Mode"",
                    hidden: true
                }],
                editable: true
    ...
    function OnEdit(e) {
        ...
        grid_validate_msg = ""Given quantity is greate");
            WriteLiteral(@"r than stock"";
        e.container.find(""input[name='In_qty']"").focusout(function () {
            if (parseFloat(e.model.In_qty) == 0) {
                ...
                kendoAlert(""Quantity Can't Be Zero for the Product"" + e.model.In_item_name);
                return false;
            }
        ...
        try {
                    ...
                    schema: {
                        model: {
                            fields: {
                                ...
                                In_pro");
            WriteLiteral(@"duct_code: { type: ""string"" },
            ...
            WriteLiteral(@"},
                    ...
                    },
                    {
                        ...
                        title: ""Product Sub-Category"",
                        editor: function (container, options) {
                            combo_editor_man(container, ""cmb_"" + options.field, eval(options.field + ""_list""), options.field, """", ""g");
            WriteLiteral(@"rid_invoice"")
                        },
                        width: 120,
                        hidden: true
                    },
    ...
    function Validate() {
        ...
        $.each(result1, function (index, value) {
            ...
            if (In_rate == undefined || In_rate == 0 || In_rate == """") {
                kendoAlert(""Amount Can't Be Zero for the Product Name   "" + value.In_item_name);
                validate = false;
            }
        })
...
");
            WriteLiteral(@"                                In_qty: { type: ""string"" },
                                    ...
                                    validation: {
                                        dropdownlistValidation: function (input) {
                                            if (input.is(""[name='In_location']"")) {
                                                var isValid = true;
                                                input.attr(""data-dropdownlistValidation-msg"", ""location cannot be blank""); if (input.val().length <= 0) {
                                                    isValid = false;
                                                }
                                                return isValid;
                                            }
            ...
            WriteLiteral(@""", defaultValue: ""I"" },
                ...
                save: function (data) {
                    ...
                    if (data.values.In_no_of_bags) {
                        ...
                        d");
            WriteLiteral(@"ata.model.set(""Transportslno"", $(""#json"").val());
        ...
        ");
            ...
            WriteLiteral(@") {
                ...
                },
                {
                    ...
                    attributes: { style: ""text-align:right;"" },
                    edito");
            WriteLiteral(@"r: function (container, options) {
                        item_rate(container, options.field, '4', '2');
                    },
                },
                {
...
");
    ...
    function OnEdittrans(e) {
        ...
        e.container.find(""input[name='In_location']"").focusout(function () {
            ...
            for (var i = 0; i < gridData.length; i++) {
                ...
                var gridproduct = ");
            WriteLiteral(@"gridData[i].In_prodcut_code;
    ...
    function fetchtran_grid() {
        ...
        ");
            WriteLiteral(@"        dataItem.set(""Transportslno"", $(""#json"").val());
...
<script>
                ...
                dataSource: {
                    ...
                    schema: {
                        model: {
                            fields: {
                    ");
            WriteLiteral(@"            In_trans_rowid: { type: ""string"" },
  ...
  ");
    ...
    load_master_code();
    In_cost_type_list = grid_comboScreen_mastercodes(""QCD");
            WriteLiteral(@"_BIOTHERCOSTTYPE"");
...
<script>
 ...
 ");
     ...
     ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "20fdb3dfd1717eca71879b81058b4c962a2130ca90057", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
   ...
   ");
    ...
    function form_control() {
        var control_Name = [
            ...
            { ""dataCol"": ""buyer_code"", ""controlId"": ""buyer_code"", ""type"": ");
            WriteLiteral(@"""Text"" },
    ...
    function fetch_loc() {
        ...
        $.ajax({
          url: '");
#nullable restore
#line 1903 "D:\Live\Meity\Updated\FEB-06-2023\WEB\meity-web-frontend\FFI\Views\PAWHSNewBookInvoice\PAWHSNewBookInvoiceForm.cshtml"
...
#nullable disable
            ...
            success: function (response) {
                ...
                if (response != null) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        var list = {};
                        list.id = response[i].Out_po_rowid
                        list.code = response[i].Out_po_no;
                        list.desc = response[i].Out_po_no;
                        itemArr.push(list);
                    }
        ...
        $.ajax({
          url: '");
#nullable restore
#line 1932 "D:\Live\Meity\Updated\FEB-06-2023\WEB\meity-web-frontend\FFI\Views\PAWHSNewBookInvoice\PAWHSNewBookInvoiceForm.cshtml"
...
#nullable restore
#line 1966 "D:\Live\Meity\Updated\FEB-06-2023\WEB\meity-web-frontend\FFI\Views\PAWHSNewBookInvoice\PAWHSNewBookInvoiceForm.cshtml"
...
#nullable disable
    ...
    function setpolist() {
        ...
        $.ajax({
          url: '");
#nullable restore
#line 1990 "D:\Live\Meity\Updated\FEB-06-2023\WEB\meity-web-frontend\FFI\Views\PAWHSNewBookInvoice\PAWHSNewBookInvoiceForm.cshtml"
...
#nullable disable
  ...
  ");
            WriteLiteral(@"                  data[i].In_item_code = data[i].In_product_code;
    ...
    function generate_Invoice_InvoiceTax(res) {
        ...
        try {
            if (res != null) {
                var data = changedataType(res);
   ");
            WriteLiteral(@"             setlocalStorage(""tax_data"", data);
                res.In_tax_amount = data.In_tax;
                for (var i = 0; i < data.length; i++) {
                    ...
                    data[i].In_tax_rate = (parseFloat(data[i].In_tax_rate)).toFixed(2);
                    data[i].In_taxable_amount = (parseFloat(data[i].In_taxable_amount)).toFixed(2);
                    data[i].In_tax_amount = (parseFloat(data[i].In");
            WriteLiteral(@"_tax_amount)).toFixed(2);
                }
                gridtax(data);
...
");
            WriteLiteral(@"                var formval = form_Serialize(""invoice_form"");
                var obj_val = JSON.parse(formval);
                ...
                obj_val.In_invoice_date = getFormated_StringDate($(""#invoice #txtic_invoicedate"").val());
                ...
                var In_net = parseFloat(obj_val.In_net_amount);
                obj_val.In_net_amount = In_net;
            ...
            WriteLiteral(@"= ""Item"";
                    ...
                    if (In_tax_rate == undefined || In_tax_rate == '') {
              ...
              ");
            WriteLiteral(@"      var In_current_qty = parseFloat(value.In_current_qty);
                ...
                $.each(result2, function (index, value) {
                    ...
                    var status_code = value.In_status_code;
                ");
            WriteLiteral(@"    if (status_code == undefined || status_code == '') {
              ...
              ");
            WriteLiteral(@"      var In_tax_amount = parseFloat(value.In_tax_amount);
                    result2[index].In_tax_amount = In_tax_amount;
                });
                var obj_grid_val2 = result2;

                var grid_val3 = JSON.stringify($(""#grid_Transport"").data().kendoGrid._data);
                if (grid_val3 != ""[]"") {
                    var Bind1 = {};
                    Bind1 = grid_val3;
                    var result3 = JSON.parse(Bind1);
                    ...
                    $.each(result3, function (index, value) {
                        ...
                        if (transdtl_rowid == undefined || transdtl_rowid == '') {
                            result3[");
            WriteLiteral(@"index].In_transdtl_rowid = 0;
                        }
                        var mode_flag = value.In_mode_flag;
                        if (mode_flag == undefined || mode_flag == '') {
                ...
                ");
            WriteLiteral(@"        result3[index].In_prodcut_qty = In_prodcut_qty;
                    });
                    var obj_grid_val3 = result3;

                }
                else {
                    kendoAlert(""Please Fill the Transport Tab..!"");
                    return false;
                }
    ...
    ");
            WriteLiteral(@"                        var mode_flag = result5[i]['In_mode_flag'];
                            if (mode_flag == undefined || mode_flag == '') {
                                result5[i]['In_mode_flag'] = ""I"";
                            }
                    ...
                    //    }
                    /");
            WriteLiteral(@"/    var mode_flag = value.In_mode_flag;
                    //    if (mode_flag == undefined || mode_flag == '') {
                    //        result5[index].In_mode_flag = ""I"";
                    //    }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.context != null) {
                    ...
                    generate_invoice_taxdetail(response.context.Header.TaxDetails);
                    generate_invoice_t");
            WriteLiteral(@"ransportdetail(response.context.Header.transport);
                    generate_invoice_otherdetail(response.context.Header.othercost);
                    enable();
                    TotalAmount();
                }
