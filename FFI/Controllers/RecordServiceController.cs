...
{
    public class RecordServiceController : Controller
    {
        // GET: RecordService
        //Muralidharan developed on 13-05-2020
        private IConfiguration _configuration;
        string urlstring = "";
        public RecordServiceController(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        public ActionResult RecordService()
        {
            return View();
        }
        ...
        public ActionResult FetchServiceList([FromBody]Context objContext)
        {
            ...
            {
                string Urlcon = "FISCertifiDes/";
                client.BaseAddress = new Uri(urlstring + Urlcon);
               // client.BaseAddress = new Uri("http://169.38.77.190:101/api/FISCertifiDes/");
                ...
                var response = client.PostAsync("service_req_Dispatch", content).Result;
        ...
        [HttpPost]
        public ActionResult SaveServiceDispatch([FromBody]SaveContext objContext)
        {
            ...
            using (var client = new HttpClient()) 
            {
              ...
              //  client.BaseAddress = new Uri("http://169.38.77.190:101/api/FISCertifiDes/");
                ...
                var response = client.PostAsync("newCertificateDispatch", content).Result;
                Stream data = response.Content.ReadAsStreamAsync().Result;
                StreamReader reader = new StreamReader(data);
                post_data = reader.ReadToEnd();
            }
