...
{
    public class PAWHSNEWApproveProcurementController : Controller
    {
        private IConfiguration _configuration;
        public PAWHSNEWApproveProcurementController(IConfiguration configuration)
        {
        ...
        public IActionResult PAWHSNEWApproveProcurementList()
        {
            return View();
        }
        public ActionResult PAWHSNEWApproveProcurementForm()
        {
            return View();
        }
        ...
        public class pawhs_NewActual_Proc_ALL_Context
        {
            ...
            public IList<approved_List> approved_List { get; set; }
            public IList<estimate_List> estimate_List { get; set; }
            public IList<actual_List> actual_List { get; set; }

        }
        public class actual_List
        { }
        public class estimate_List
        {          
        }
        public class approved_List
        {
        ...
        public ActionResult GetActualProcurementList([FromBody] pawhs_NewActual_Proc_ALL_Context objContext)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var response = client.PostAsync("Estimate_Actual_Approved_List", content).Result;
