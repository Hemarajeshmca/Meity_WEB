...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        #region
        [HttpPost]
        public string GetTaluk(string fpo_code, string dist_code)
        {
        ...
        #region
        [HttpPost]
        public string GetVillage(string fpo_code, string dist_code, string taluk_code)
        {
            DataTable dt = new DataTable();
            try
        ...
        //GetDistrict 
        [HttpPost]
        public string GetDistrict(string fpo_code)
        {
            DataTable dt = new DataTable();
