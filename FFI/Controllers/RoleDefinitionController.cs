...
namespace FFI.Controllers
{
    public class RoleDefinitionController : Controller
    {
        ...
        public ActionResult RoleDefinitionList([FromBody] RoleManagementContext objContext)
        {
            ...
            {
                // string Urlcon = "/allroles?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&user=" + objContext.userId + "&lang=" + objContext.localeId;
                string Urlcon = "Admin_RoleManagement/";
        ...
        [HttpPost]
        //public ActionResult RoleDefinitionfetch([FromBody] FetchRoleManagementContext objContext)
