...
namespace FFI.Controllers
{
    public class UserDefinitionController : Controller
    {
        ...
        public ActionResult UserMapForm()
        {
            return View();
        }
        ...
        public ActionResult userDefinitionList([FromBody]Context objContext)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                string Urlcon = "Admin_UserManagement/";
        ...
        public ActionResult SaveUserMap([FromBody] MapContext objContext)
        {
            MapApplication objRoot = new MapApplication();
            MapDocument objDoc = new MapDocument();
            MapContext objContextDetails = new MapContext();
            objContextDetails.userId = objContext.userId;
            objContextDetails.locnId = objContext.locnId;
            objContextDetails.localeId = objContext.localeId;
            objContextDetails.orgnId = objContext.orgnId;
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                HttpContent content = new StringContent(JsonConvert.SerializeObject(objRoot), UTF8Encoding.UTF8, "application/json");
                var response = client.PostAsync("newusermap", content).Result;
                Stream data = response.Content.ReadAsStreamAsync().Result;
                StreamReader reader = new StreamReader(data);
                post_data = reader.ReadToEnd();
            }
        ...
        public ActionResult UserFPOfetch([FromBody] Context objContext)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                HttpContent content = new StringContent(JsonConvert.SerializeObject(objContext), UTF8Encoding.UTF8, "application/json");
                var response = client.GetAsync("fpouserlist?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&user=" + objContext.userId + "&lang=" + objContext.localeId + "&user_code=" + objContext.user_code + "").Result;
                Stream data = response.Content.ReadAsStreamAsync().Result;
                StreamReader reader = new StreamReader(data);
                post_data = reader.ReadToEnd();
                objList = (FPOUSERList)JsonConvert.DeserializeObject(post_data, typeof(FPOUSERList));

            }
            return Json(objList);
        }
        public ActionResult userMapList([FromBody] Context objContext)
        {
            RootObject objList = new RootObject();
            string post_data = "";
            if (_configuration.GetSection("AppSettings")["Environment"].ToString() == "DEV")
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                HttpContent content = new StringContent(JsonConvert.SerializeObject(objContext), UTF8Encoding.UTF8, "application/json");
                var response = client.GetAsync("allmaplist?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&user=" + objContext.userId + "&lang=" + objContext.localeId + "").Result;
                Stream data = response.Content.ReadAsStreamAsync().Result;
                StreamReader reader = new StreamReader(data);
                post_data = reader.ReadToEnd();
                objList = (RootObject)JsonConvert.DeserializeObject(post_data, typeof(RootObject));
        ...
        public ActionResult FPOList([FromBody] FPOLISTContext objContext)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                HttpContent content = new StringContent(JsonConvert.SerializeObject(objContext), UTF8Encoding.UTF8, "application/json");
                var response = client.GetAsync("FPOlist?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&user=" + objContext.userId + "&lang=" + objContext.localeId + "").Result;
                Stream data = response.Content.ReadAsStreamAsync().Result;
                StreamReader reader = new StreamReader(data);
                post_data = reader.ReadToEnd();
                objList = (FPOListGL)JsonConvert.DeserializeObject(post_data, typeof(FPOListGL));
