...
namespace FFI.Controllers
{
    public class MastersDefinitionController : Controller
    {
        ...
        public ActionResult MasterDefinitionList([FromBody]Context objContext)
        {
            ...
            {
                //string Urlcon = "/allmasterlist?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&user=" + objContext.userId + "&lang=" + objContext.localeId + "&parent_code=" + objContext.parent_code;
        ...
        public ActionResult MasterDefinitionsingle([FromBody]Contextsingle objContext)
        {
            ...
            using (var client = new HttpClient())
            {
                //string Urlcon = "/mastercode?org=" + objContext.orgnId + "&locn=" + objContext.locnId + "&user=" + objContext.userId + "&lang=" + objContext.localeId + "&parent_code=" + objContext.parent_code;
                //client.BaseAddress = new Uri(urlstring + Urlcon);
                //client.DefaultRequestHeaders.Accept.Clear();
                //client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                //HttpContent content = new StringContent(JsonConvert.SerializeObject(""), UTF8Encoding.UTF8, "application/json");
