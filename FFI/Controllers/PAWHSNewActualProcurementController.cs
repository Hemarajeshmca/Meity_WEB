...
{
    public class PAWHSNewActualProcurementController : Controller
    {
        private IConfiguration _configuration;
        public PAWHSNewActualProcurementController(IConfiguration configuration)
        {
        ...
        public IActionResult PAWHSNewActualProcurementList()
        {
            return View();
        }
        public ActionResult PAWHSNewActualProcurementForm()
        {
            return View();
        }
        ...
        public ActionResult GetActualProcurementList([FromBody] pawhs_NewActual_Proc_ALL_Context objContext)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var response = client.PostAsync("new_pawhs_ActualProc_List", content).Result;
        ...
        [HttpPost]
        public JsonResult DownloadImage(string base64)
        {
            WebClient cl = new WebClient();
            byte[] fileBytes = Convert.FromBase64String(base64);
            //string filepath = "D:\\MandateManager\\MandateDownloads";
            string filename = "bill-image.jpg";
            //string filepath1 = filepath + "\\" + filename;
            //string file = filepath1;
